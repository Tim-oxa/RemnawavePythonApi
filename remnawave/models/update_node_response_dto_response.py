...
if TYPE_CHECKING:
    from ..models.update_node_response_dto_response_config_profile import UpdateNodeResponseDtoResponseConfigProfile
    from ..models.update_node_response_dto_response_provider_type_0 import UpdateNodeResponseDtoResponseProviderType0


T = TypeVar("T", bound="UpdateNodeResponseDtoResponse")


@_attrs_define
class UpdateNodeResponseDtoResponse:
    """
    Attributes:
        uuid (UUID):
        name (str):
        ...
        config_profile (UpdateNodeResponseDtoResponseConfigProfile):
        provider_uuid (Union[None, UUID]):
        provider (Union['UpdateNodeResponseDtoResponseProviderType0', None]):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.update_node_response_dto_response_provider_type_0 import (
        ...
        if isinstance(self.provider, UpdateNodeResponseDtoResponseProviderType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config_profile = UpdateNodeResponseDtoResponseConfigProfile.from_dict(d.pop("configProfile"))
        ...
        def _parse_provider(data: object) -> Union["UpdateNodeResponseDtoResponseProviderType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                provider_type_0 = UpdateNodeResponseDtoResponseProviderType0.from_dict(data)

                return provider_type_0
            except:  # noqa: E722
                pass
            return cast(Union["UpdateNodeResponseDtoResponseProviderType0", None], data)

        provider = _parse_provider(d.pop("provider"))

        update_node_response_dto_response = cls(
            uuid=uuid,
            name=name,
            address=address,
            port=port,
        ...
        update_node_response_dto_response.additional_properties = d
        return update_node_response_dto_response
