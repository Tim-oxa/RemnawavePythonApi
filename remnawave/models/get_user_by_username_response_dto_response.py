...
from ..models.get_user_by_username_response_dto_response_status import GetUserByUsernameResponseDtoResponseStatus
from ..models.get_user_by_username_response_dto_response_traffic_limit_strategy import (
    GetUserByUsernameResponseDtoResponseTrafficLimitStrategy,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_user_by_username_response_dto_response_active_internal_squads_item import (
        GetUserByUsernameResponseDtoResponseActiveInternalSquadsItem,
    )
    from ..models.get_user_by_username_response_dto_response_happ import GetUserByUsernameResponseDtoResponseHapp
    from ..models.get_user_by_username_response_dto_response_last_connected_node_type_0 import (
        GetUserByUsernameResponseDtoResponseLastConnectedNodeType0,
    )


T = TypeVar("T", bound="GetUserByUsernameResponseDtoResponse")


@_attrs_define
class GetUserByUsernameResponseDtoResponse:
    """
    Attributes:
        uuid (UUID):
        short_uuid (str):
        ...
        active_internal_squads (list['GetUserByUsernameResponseDtoResponseActiveInternalSquadsItem']):
        subscription_url (str):
        last_connected_node (Union['GetUserByUsernameResponseDtoResponseLastConnectedNodeType0', None]):
        happ (GetUserByUsernameResponseDtoResponseHapp):
        status (Union[Unset, GetUserByUsernameResponseDtoResponseStatus]):  Default:
            GetUserByUsernameResponseDtoResponseStatus.ACTIVE.
        traffic_limit_bytes (Union[Unset, int]):  Default: 0.
        traffic_limit_strategy (Union[Unset, GetUserByUsernameResponseDtoResponseTrafficLimitStrategy]): Available reset
            periods Default: GetUserByUsernameResponseDtoResponseTrafficLimitStrategy.NO_RESET.
    ...
    last_connected_node: Union["GetUserByUsernameResponseDtoResponseLastConnectedNodeType0", None]
    happ: "GetUserByUsernameResponseDtoResponseHapp"
    status: Union[Unset, GetUserByUsernameResponseDtoResponseStatus] = GetUserByUsernameResponseDtoResponseStatus.ACTIVE
    traffic_limit_bytes: Union[Unset, int] = 0
    traffic_limit_strategy: Union[Unset, GetUserByUsernameResponseDtoResponseTrafficLimitStrategy] = (
        GetUserByUsernameResponseDtoResponseTrafficLimitStrategy.NO_RESET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.last_connected_node, GetUserByUsernameResponseDtoResponseLastConnectedNodeType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_internal_squads_item_data in _active_internal_squads:
            active_internal_squads_item = GetUserByUsernameResponseDtoResponseActiveInternalSquadsItem.from_dict(
        ...
        def _parse_last_connected_node(
            data: object,
        ) -> Union["GetUserByUsernameResponseDtoResponseLastConnectedNodeType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_connected_node_type_0 = GetUserByUsernameResponseDtoResponseLastConnectedNodeType0.from_dict(data)

                return last_connected_node_type_0
            except:  # noqa: E722
                pass
            return cast(Union["GetUserByUsernameResponseDtoResponseLastConnectedNodeType0", None], data)

        last_connected_node = _parse_last_connected_node(d.pop("lastConnectedNode"))

        happ = GetUserByUsernameResponseDtoResponseHapp.from_dict(d.pop("happ"))

        _status = d.pop("status", UNSET)
        status: Union[Unset, GetUserByUsernameResponseDtoResponseStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = GetUserByUsernameResponseDtoResponseStatus(_status)
        ...
        if isinstance(_traffic_limit_strategy, Unset):
            ...
            traffic_limit_strategy = GetUserByUsernameResponseDtoResponseTrafficLimitStrategy(_traffic_limit_strategy)

        last_triggered_threshold = d.pop("lastTriggeredThreshold", UNSET)

        get_user_by_username_response_dto_response = cls(
            uuid=uuid,
        ...
        get_user_by_username_response_dto_response.additional_properties = d
        return get_user_by_username_response_dto_response
