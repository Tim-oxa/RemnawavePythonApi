...
T = TypeVar("T", bound="DisableNodeResponseDtoResponseConfigProfileActiveInboundsItem")


@_attrs_define
class DisableNodeResponseDtoResponseConfigProfileActiveInboundsItem:
    """
    Attributes:
        uuid (UUID):
        profile_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        disable_node_response_dto_response_config_profile_active_inbounds_item = cls(
            uuid=uuid,
        ...
        disable_node_response_dto_response_config_profile_active_inbounds_item.additional_properties = d
        return disable_node_response_dto_response_config_profile_active_inbounds_item
