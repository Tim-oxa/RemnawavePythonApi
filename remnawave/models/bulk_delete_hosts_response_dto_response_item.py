...
from ..models.bulk_delete_hosts_response_dto_response_item_security_layer import (
    BulkDeleteHostsResponseDtoResponseItemSecurityLayer,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.bulk_delete_hosts_response_dto_response_item_inbound import (
        BulkDeleteHostsResponseDtoResponseItemInbound,
    )


T = TypeVar("T", bound="BulkDeleteHostsResponseDtoResponseItem")


@_attrs_define
class BulkDeleteHostsResponseDtoResponseItem:
    """
    Attributes:
        uuid (UUID):
        view_position (int):
        ...
        mux_params (Any):
        sockopt_params (Any):
        inbound (BulkDeleteHostsResponseDtoResponseItemInbound):
        server_description (Union[None, str]):
        tag (Union[None, str]):
        is_disabled (Union[Unset, bool]):  Default: False.
        security_layer (Union[Unset, BulkDeleteHostsResponseDtoResponseItemSecurityLayer]):  Default:
            BulkDeleteHostsResponseDtoResponseItemSecurityLayer.DEFAULT.
    ...
    security_layer: Union[Unset, BulkDeleteHostsResponseDtoResponseItemSecurityLayer] = (
        BulkDeleteHostsResponseDtoResponseItemSecurityLayer.DEFAULT
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inbound = BulkDeleteHostsResponseDtoResponseItemInbound.from_dict(d.pop("inbound"))
        ...
        if isinstance(_security_layer, Unset):
            ...
            security_layer = BulkDeleteHostsResponseDtoResponseItemSecurityLayer(_security_layer)

        is_hidden = d.pop("isHidden", UNSET)

        override_sni_from_address = d.pop("overrideSniFromAddress", UNSET)

        bulk_delete_hosts_response_dto_response_item = cls(
            uuid=uuid,
        ...
        bulk_delete_hosts_response_dto_response_item.additional_properties = d
        return bulk_delete_hosts_response_dto_response_item
