...
if TYPE_CHECKING:
    from ..models.get_all_nodes_response_dto_response_item_config_profile import (
        GetAllNodesResponseDtoResponseItemConfigProfile,
    )
    from ..models.get_all_nodes_response_dto_response_item_provider_type_0 import (
        GetAllNodesResponseDtoResponseItemProviderType0,
    )


T = TypeVar("T", bound="GetAllNodesResponseDtoResponseItem")


@_attrs_define
class GetAllNodesResponseDtoResponseItem:
    """
    Attributes:
        uuid (UUID):
        name (str):
        ...
        config_profile (GetAllNodesResponseDtoResponseItemConfigProfile):
        provider_uuid (Union[None, UUID]):
        provider (Union['GetAllNodesResponseDtoResponseItemProviderType0', None]):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.provider, GetAllNodesResponseDtoResponseItemProviderType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config_profile = GetAllNodesResponseDtoResponseItemConfigProfile.from_dict(d.pop("configProfile"))
        ...
        def _parse_provider(data: object) -> Union["GetAllNodesResponseDtoResponseItemProviderType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                provider_type_0 = GetAllNodesResponseDtoResponseItemProviderType0.from_dict(data)

                return provider_type_0
            except:  # noqa: E722
                pass
            return cast(Union["GetAllNodesResponseDtoResponseItemProviderType0", None], data)

        provider = _parse_provider(d.pop("provider"))

        get_all_nodes_response_dto_response_item = cls(
            uuid=uuid,
            name=name,
            address=address,
            port=port,
        ...
        get_all_nodes_response_dto_response_item.additional_properties = d
        return get_all_nodes_response_dto_response_item
