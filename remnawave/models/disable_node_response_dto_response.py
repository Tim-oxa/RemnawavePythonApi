...
if TYPE_CHECKING:
    from ..models.disable_node_response_dto_response_config_profile import DisableNodeResponseDtoResponseConfigProfile
    from ..models.disable_node_response_dto_response_provider_type_0 import DisableNodeResponseDtoResponseProviderType0


T = TypeVar("T", bound="DisableNodeResponseDtoResponse")


@_attrs_define
class DisableNodeResponseDtoResponse:
    """
    Attributes:
        uuid (UUID):
        name (str):
        ...
        config_profile (DisableNodeResponseDtoResponseConfigProfile):
        provider_uuid (Union[None, UUID]):
        provider (Union['DisableNodeResponseDtoResponseProviderType0', None]):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.disable_node_response_dto_response_provider_type_0 import (
        ...
        if isinstance(self.provider, DisableNodeResponseDtoResponseProviderType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.disable_node_response_dto_response_config_profile import (
        ...
        config_profile = DisableNodeResponseDtoResponseConfigProfile.from_dict(d.pop("configProfile"))
        ...
        def _parse_provider(data: object) -> Union["DisableNodeResponseDtoResponseProviderType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                provider_type_0 = DisableNodeResponseDtoResponseProviderType0.from_dict(data)

                return provider_type_0
            except:  # noqa: E722
                pass
            return cast(Union["DisableNodeResponseDtoResponseProviderType0", None], data)

        provider = _parse_provider(d.pop("provider"))

        disable_node_response_dto_response = cls(
            uuid=uuid,
            name=name,
            address=address,
            port=port,
        ...
        disable_node_response_dto_response.additional_properties = d
        return disable_node_response_dto_response
