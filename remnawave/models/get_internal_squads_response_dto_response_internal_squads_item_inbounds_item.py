...
T = TypeVar("T", bound="GetInternalSquadsResponseDtoResponseInternalSquadsItemInboundsItem")


@_attrs_define
class GetInternalSquadsResponseDtoResponseInternalSquadsItemInboundsItem:
    """
    Attributes:
        uuid (UUID):
        profile_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_internal_squads_response_dto_response_internal_squads_item_inbounds_item = cls(
            uuid=uuid,
        ...
        get_internal_squads_response_dto_response_internal_squads_item_inbounds_item.additional_properties = d
        return get_internal_squads_response_dto_response_internal_squads_item_inbounds_item
