...
from ..models.revoke_user_subscription_response_dto_response_status import (
    RevokeUserSubscriptionResponseDtoResponseStatus,
)
from ..models.revoke_user_subscription_response_dto_response_traffic_limit_strategy import (
    RevokeUserSubscriptionResponseDtoResponseTrafficLimitStrategy,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.revoke_user_subscription_response_dto_response_active_internal_squads_item import (
        RevokeUserSubscriptionResponseDtoResponseActiveInternalSquadsItem,
    )
    from ..models.revoke_user_subscription_response_dto_response_happ import (
        RevokeUserSubscriptionResponseDtoResponseHapp,
    )
    from ..models.revoke_user_subscription_response_dto_response_last_connected_node_type_0 import (
        RevokeUserSubscriptionResponseDtoResponseLastConnectedNodeType0,
    )


T = TypeVar("T", bound="RevokeUserSubscriptionResponseDtoResponse")


@_attrs_define
class RevokeUserSubscriptionResponseDtoResponse:
    """
    Attributes:
        uuid (UUID):
        short_uuid (str):
        ...
        active_internal_squads (list['RevokeUserSubscriptionResponseDtoResponseActiveInternalSquadsItem']):
        subscription_url (str):
        last_connected_node (Union['RevokeUserSubscriptionResponseDtoResponseLastConnectedNodeType0', None]):
        happ (RevokeUserSubscriptionResponseDtoResponseHapp):
        status (Union[Unset, RevokeUserSubscriptionResponseDtoResponseStatus]):  Default:
            RevokeUserSubscriptionResponseDtoResponseStatus.ACTIVE.
        traffic_limit_bytes (Union[Unset, int]):  Default: 0.
        traffic_limit_strategy (Union[Unset, RevokeUserSubscriptionResponseDtoResponseTrafficLimitStrategy]): Available
            reset periods Default: RevokeUserSubscriptionResponseDtoResponseTrafficLimitStrategy.NO_RESET.
    ...
    last_connected_node: Union["RevokeUserSubscriptionResponseDtoResponseLastConnectedNodeType0", None]
    happ: "RevokeUserSubscriptionResponseDtoResponseHapp"
    status: Union[Unset, RevokeUserSubscriptionResponseDtoResponseStatus] = (
        RevokeUserSubscriptionResponseDtoResponseStatus.ACTIVE
    )
    traffic_limit_bytes: Union[Unset, int] = 0
    traffic_limit_strategy: Union[Unset, RevokeUserSubscriptionResponseDtoResponseTrafficLimitStrategy] = (
        RevokeUserSubscriptionResponseDtoResponseTrafficLimitStrategy.NO_RESET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.last_connected_node, RevokeUserSubscriptionResponseDtoResponseLastConnectedNodeType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_internal_squads_item_data in _active_internal_squads:
            active_internal_squads_item = RevokeUserSubscriptionResponseDtoResponseActiveInternalSquadsItem.from_dict(
        ...
        def _parse_last_connected_node(
            data: object,
        ) -> Union["RevokeUserSubscriptionResponseDtoResponseLastConnectedNodeType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_connected_node_type_0 = RevokeUserSubscriptionResponseDtoResponseLastConnectedNodeType0.from_dict(
                    data
                )
                ...
                pass
            return cast(Union["RevokeUserSubscriptionResponseDtoResponseLastConnectedNodeType0", None], data)

        last_connected_node = _parse_last_connected_node(d.pop("lastConnectedNode"))

        happ = RevokeUserSubscriptionResponseDtoResponseHapp.from_dict(d.pop("happ"))
        ...
        if isinstance(_status, Unset):
            ...
            status = RevokeUserSubscriptionResponseDtoResponseStatus(_status)
        ...
        if isinstance(_traffic_limit_strategy, Unset):
            ...
            traffic_limit_strategy = RevokeUserSubscriptionResponseDtoResponseTrafficLimitStrategy(
                _traffic_limit_strategy
            )

        last_triggered_threshold = d.pop("lastTriggeredThreshold", UNSET)

        revoke_user_subscription_response_dto_response = cls(
            uuid=uuid,
        ...
        revoke_user_subscription_response_dto_response.additional_properties = d
        return revoke_user_subscription_response_dto_response
