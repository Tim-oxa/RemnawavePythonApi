...
from ..models.get_user_by_telegram_id_response_dto_response_item_status import (
    GetUserByTelegramIdResponseDtoResponseItemStatus,
)
from ..models.get_user_by_telegram_id_response_dto_response_item_traffic_limit_strategy import (
    GetUserByTelegramIdResponseDtoResponseItemTrafficLimitStrategy,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_user_by_telegram_id_response_dto_response_item_active_internal_squads_item import (
        GetUserByTelegramIdResponseDtoResponseItemActiveInternalSquadsItem,
    )
    from ..models.get_user_by_telegram_id_response_dto_response_item_happ import (
        GetUserByTelegramIdResponseDtoResponseItemHapp,
    )
    from ..models.get_user_by_telegram_id_response_dto_response_item_last_connected_node_type_0 import (
        GetUserByTelegramIdResponseDtoResponseItemLastConnectedNodeType0,
    )


T = TypeVar("T", bound="GetUserByTelegramIdResponseDtoResponseItem")


@_attrs_define
class GetUserByTelegramIdResponseDtoResponseItem:
    """
    Attributes:
        uuid (UUID):
        short_uuid (str):
        ...
        active_internal_squads (list['GetUserByTelegramIdResponseDtoResponseItemActiveInternalSquadsItem']):
        subscription_url (str):
        last_connected_node (Union['GetUserByTelegramIdResponseDtoResponseItemLastConnectedNodeType0', None]):
        happ (GetUserByTelegramIdResponseDtoResponseItemHapp):
        status (Union[Unset, GetUserByTelegramIdResponseDtoResponseItemStatus]):  Default:
            GetUserByTelegramIdResponseDtoResponseItemStatus.ACTIVE.
        traffic_limit_bytes (Union[Unset, int]):  Default: 0.
        traffic_limit_strategy (Union[Unset, GetUserByTelegramIdResponseDtoResponseItemTrafficLimitStrategy]): Available
            reset periods Default: GetUserByTelegramIdResponseDtoResponseItemTrafficLimitStrategy.NO_RESET.
    ...
    last_connected_node: Union["GetUserByTelegramIdResponseDtoResponseItemLastConnectedNodeType0", None]
    happ: "GetUserByTelegramIdResponseDtoResponseItemHapp"
    status: Union[Unset, GetUserByTelegramIdResponseDtoResponseItemStatus] = (
        GetUserByTelegramIdResponseDtoResponseItemStatus.ACTIVE
    )
    traffic_limit_bytes: Union[Unset, int] = 0
    traffic_limit_strategy: Union[Unset, GetUserByTelegramIdResponseDtoResponseItemTrafficLimitStrategy] = (
        GetUserByTelegramIdResponseDtoResponseItemTrafficLimitStrategy.NO_RESET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.last_connected_node, GetUserByTelegramIdResponseDtoResponseItemLastConnectedNodeType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_internal_squads_item_data in _active_internal_squads:
            active_internal_squads_item = GetUserByTelegramIdResponseDtoResponseItemActiveInternalSquadsItem.from_dict(
        ...
        def _parse_last_connected_node(
            data: object,
        ) -> Union["GetUserByTelegramIdResponseDtoResponseItemLastConnectedNodeType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_connected_node_type_0 = GetUserByTelegramIdResponseDtoResponseItemLastConnectedNodeType0.from_dict(
                    data
                )
                ...
                pass
            return cast(Union["GetUserByTelegramIdResponseDtoResponseItemLastConnectedNodeType0", None], data)

        last_connected_node = _parse_last_connected_node(d.pop("lastConnectedNode"))

        happ = GetUserByTelegramIdResponseDtoResponseItemHapp.from_dict(d.pop("happ"))
        ...
        if isinstance(_status, Unset):
            ...
            status = GetUserByTelegramIdResponseDtoResponseItemStatus(_status)
        ...
        if isinstance(_traffic_limit_strategy, Unset):
            ...
            traffic_limit_strategy = GetUserByTelegramIdResponseDtoResponseItemTrafficLimitStrategy(
                _traffic_limit_strategy
            )

        last_triggered_threshold = d.pop("lastTriggeredThreshold", UNSET)

        get_user_by_telegram_id_response_dto_response_item = cls(
            uuid=uuid,
        ...
        get_user_by_telegram_id_response_dto_response_item.additional_properties = d
        return get_user_by_telegram_id_response_dto_response_item
