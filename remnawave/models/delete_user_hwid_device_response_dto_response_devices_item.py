...
T = TypeVar("T", bound="DeleteUserHwidDeviceResponseDtoResponseDevicesItem")


@_attrs_define
class DeleteUserHwidDeviceResponseDtoResponseDevicesItem:
    """
    Attributes:
        hwid (str):
        user_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_user_hwid_device_response_dto_response_devices_item = cls(
            hwid=hwid,
            user_uuid=user_uuid,
            platform=platform,
        ...
        delete_user_hwid_device_response_dto_response_devices_item.additional_properties = d
        return delete_user_hwid_device_response_dto_response_devices_item
