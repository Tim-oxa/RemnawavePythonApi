...
if TYPE_CHECKING:
    from ..models.get_one_node_response_dto_response_config_profile import GetOneNodeResponseDtoResponseConfigProfile
    from ..models.get_one_node_response_dto_response_provider_type_0 import GetOneNodeResponseDtoResponseProviderType0


T = TypeVar("T", bound="GetOneNodeResponseDtoResponse")


@_attrs_define
class GetOneNodeResponseDtoResponse:
    """
    Attributes:
        uuid (UUID):
        name (str):
        ...
        config_profile (GetOneNodeResponseDtoResponseConfigProfile):
        provider_uuid (Union[None, UUID]):
        provider (Union['GetOneNodeResponseDtoResponseProviderType0', None]):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.get_one_node_response_dto_response_provider_type_0 import (
        ...
        if isinstance(self.provider, GetOneNodeResponseDtoResponseProviderType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.get_one_node_response_dto_response_config_profile import (
        ...
        config_profile = GetOneNodeResponseDtoResponseConfigProfile.from_dict(d.pop("configProfile"))
        ...
        def _parse_provider(data: object) -> Union["GetOneNodeResponseDtoResponseProviderType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                provider_type_0 = GetOneNodeResponseDtoResponseProviderType0.from_dict(data)

                return provider_type_0
            except:  # noqa: E722
                pass
            return cast(Union["GetOneNodeResponseDtoResponseProviderType0", None], data)

        provider = _parse_provider(d.pop("provider"))

        get_one_node_response_dto_response = cls(
            uuid=uuid,
            name=name,
            address=address,
            port=port,
        ...
        get_one_node_response_dto_response.additional_properties = d
        return get_one_node_response_dto_response
