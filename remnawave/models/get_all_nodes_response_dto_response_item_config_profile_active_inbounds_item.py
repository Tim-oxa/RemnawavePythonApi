...
T = TypeVar("T", bound="GetAllNodesResponseDtoResponseItemConfigProfileActiveInboundsItem")


@_attrs_define
class GetAllNodesResponseDtoResponseItemConfigProfileActiveInboundsItem:
    """
    Attributes:
        uuid (UUID):
        profile_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_all_nodes_response_dto_response_item_config_profile_active_inbounds_item = cls(
            uuid=uuid,
        ...
        get_all_nodes_response_dto_response_item_config_profile_active_inbounds_item.additional_properties = d
        return get_all_nodes_response_dto_response_item_config_profile_active_inbounds_item
