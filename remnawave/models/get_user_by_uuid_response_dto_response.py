...
from ..models.get_user_by_uuid_response_dto_response_status import GetUserByUuidResponseDtoResponseStatus
from ..models.get_user_by_uuid_response_dto_response_traffic_limit_strategy import (
    GetUserByUuidResponseDtoResponseTrafficLimitStrategy,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_user_by_uuid_response_dto_response_active_internal_squads_item import (
        GetUserByUuidResponseDtoResponseActiveInternalSquadsItem,
    )
    from ..models.get_user_by_uuid_response_dto_response_happ import GetUserByUuidResponseDtoResponseHapp
    from ..models.get_user_by_uuid_response_dto_response_last_connected_node_type_0 import (
        GetUserByUuidResponseDtoResponseLastConnectedNodeType0,
    )


T = TypeVar("T", bound="GetUserByUuidResponseDtoResponse")


@_attrs_define
class GetUserByUuidResponseDtoResponse:
    """
    Attributes:
        uuid (UUID):
        short_uuid (str):
        ...
        active_internal_squads (list['GetUserByUuidResponseDtoResponseActiveInternalSquadsItem']):
        subscription_url (str):
        last_connected_node (Union['GetUserByUuidResponseDtoResponseLastConnectedNodeType0', None]):
        happ (GetUserByUuidResponseDtoResponseHapp):
        status (Union[Unset, GetUserByUuidResponseDtoResponseStatus]):  Default:
            GetUserByUuidResponseDtoResponseStatus.ACTIVE.
        traffic_limit_bytes (Union[Unset, int]):  Default: 0.
        traffic_limit_strategy (Union[Unset, GetUserByUuidResponseDtoResponseTrafficLimitStrategy]): Available reset
            periods Default: GetUserByUuidResponseDtoResponseTrafficLimitStrategy.NO_RESET.
    ...
    last_connected_node: Union["GetUserByUuidResponseDtoResponseLastConnectedNodeType0", None]
    happ: "GetUserByUuidResponseDtoResponseHapp"
    status: Union[Unset, GetUserByUuidResponseDtoResponseStatus] = GetUserByUuidResponseDtoResponseStatus.ACTIVE
    traffic_limit_bytes: Union[Unset, int] = 0
    traffic_limit_strategy: Union[Unset, GetUserByUuidResponseDtoResponseTrafficLimitStrategy] = (
        GetUserByUuidResponseDtoResponseTrafficLimitStrategy.NO_RESET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.last_connected_node, GetUserByUuidResponseDtoResponseLastConnectedNodeType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_internal_squads_item_data in _active_internal_squads:
            active_internal_squads_item = GetUserByUuidResponseDtoResponseActiveInternalSquadsItem.from_dict(
        ...
        def _parse_last_connected_node(
            data: object,
        ) -> Union["GetUserByUuidResponseDtoResponseLastConnectedNodeType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_connected_node_type_0 = GetUserByUuidResponseDtoResponseLastConnectedNodeType0.from_dict(data)

                return last_connected_node_type_0
            except:  # noqa: E722
                pass
            return cast(Union["GetUserByUuidResponseDtoResponseLastConnectedNodeType0", None], data)

        last_connected_node = _parse_last_connected_node(d.pop("lastConnectedNode"))

        happ = GetUserByUuidResponseDtoResponseHapp.from_dict(d.pop("happ"))

        _status = d.pop("status", UNSET)
        status: Union[Unset, GetUserByUuidResponseDtoResponseStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = GetUserByUuidResponseDtoResponseStatus(_status)
        ...
        if isinstance(_traffic_limit_strategy, Unset):
            ...
            traffic_limit_strategy = GetUserByUuidResponseDtoResponseTrafficLimitStrategy(_traffic_limit_strategy)

        last_triggered_threshold = d.pop("lastTriggeredThreshold", UNSET)

        get_user_by_uuid_response_dto_response = cls(
            uuid=uuid,
        ...
        get_user_by_uuid_response_dto_response.additional_properties = d
        return get_user_by_uuid_response_dto_response
