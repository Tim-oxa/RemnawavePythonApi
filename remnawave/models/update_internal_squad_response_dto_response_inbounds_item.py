...
T = TypeVar("T", bound="UpdateInternalSquadResponseDtoResponseInboundsItem")


@_attrs_define
class UpdateInternalSquadResponseDtoResponseInboundsItem:
    """
    Attributes:
        uuid (UUID):
        profile_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_internal_squad_response_dto_response_inbounds_item = cls(
            uuid=uuid,
        ...
        update_internal_squad_response_dto_response_inbounds_item.additional_properties = d
        return update_internal_squad_response_dto_response_inbounds_item
