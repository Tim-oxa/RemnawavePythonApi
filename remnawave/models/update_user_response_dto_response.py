...
from ..models.update_user_response_dto_response_status import UpdateUserResponseDtoResponseStatus
from ..models.update_user_response_dto_response_traffic_limit_strategy import (
    UpdateUserResponseDtoResponseTrafficLimitStrategy,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.update_user_response_dto_response_active_internal_squads_item import (
        UpdateUserResponseDtoResponseActiveInternalSquadsItem,
    )
    from ..models.update_user_response_dto_response_happ import UpdateUserResponseDtoResponseHapp
    from ..models.update_user_response_dto_response_last_connected_node_type_0 import (
        UpdateUserResponseDtoResponseLastConnectedNodeType0,
    )


T = TypeVar("T", bound="UpdateUserResponseDtoResponse")


@_attrs_define
class UpdateUserResponseDtoResponse:
    """
    Attributes:
        uuid (UUID):
        short_uuid (str):
        ...
        active_internal_squads (list['UpdateUserResponseDtoResponseActiveInternalSquadsItem']):
        subscription_url (str):
        last_connected_node (Union['UpdateUserResponseDtoResponseLastConnectedNodeType0', None]):
        happ (UpdateUserResponseDtoResponseHapp):
        status (Union[Unset, UpdateUserResponseDtoResponseStatus]):  Default:
            UpdateUserResponseDtoResponseStatus.ACTIVE.
        traffic_limit_bytes (Union[Unset, int]):  Default: 0.
        traffic_limit_strategy (Union[Unset, UpdateUserResponseDtoResponseTrafficLimitStrategy]): Available reset
            periods Default: UpdateUserResponseDtoResponseTrafficLimitStrategy.NO_RESET.
    ...
    last_connected_node: Union["UpdateUserResponseDtoResponseLastConnectedNodeType0", None]
    happ: "UpdateUserResponseDtoResponseHapp"
    status: Union[Unset, UpdateUserResponseDtoResponseStatus] = UpdateUserResponseDtoResponseStatus.ACTIVE
    traffic_limit_bytes: Union[Unset, int] = 0
    traffic_limit_strategy: Union[Unset, UpdateUserResponseDtoResponseTrafficLimitStrategy] = (
        UpdateUserResponseDtoResponseTrafficLimitStrategy.NO_RESET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.last_connected_node, UpdateUserResponseDtoResponseLastConnectedNodeType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_internal_squads_item_data in _active_internal_squads:
            active_internal_squads_item = UpdateUserResponseDtoResponseActiveInternalSquadsItem.from_dict(
        ...
        def _parse_last_connected_node(
            data: object,
        ) -> Union["UpdateUserResponseDtoResponseLastConnectedNodeType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_connected_node_type_0 = UpdateUserResponseDtoResponseLastConnectedNodeType0.from_dict(data)

                return last_connected_node_type_0
            except:  # noqa: E722
                pass
            return cast(Union["UpdateUserResponseDtoResponseLastConnectedNodeType0", None], data)

        last_connected_node = _parse_last_connected_node(d.pop("lastConnectedNode"))

        happ = UpdateUserResponseDtoResponseHapp.from_dict(d.pop("happ"))

        _status = d.pop("status", UNSET)
        status: Union[Unset, UpdateUserResponseDtoResponseStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = UpdateUserResponseDtoResponseStatus(_status)
        ...
        if isinstance(_traffic_limit_strategy, Unset):
            ...
            traffic_limit_strategy = UpdateUserResponseDtoResponseTrafficLimitStrategy(_traffic_limit_strategy)

        last_triggered_threshold = d.pop("lastTriggeredThreshold", UNSET)

        update_user_response_dto_response = cls(
            uuid=uuid,
        ...
        update_user_response_dto_response.additional_properties = d
        return update_user_response_dto_response
