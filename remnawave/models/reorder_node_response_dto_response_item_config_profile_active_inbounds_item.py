...
T = TypeVar("T", bound="ReorderNodeResponseDtoResponseItemConfigProfileActiveInboundsItem")


@_attrs_define
class ReorderNodeResponseDtoResponseItemConfigProfileActiveInboundsItem:
    """
    Attributes:
        uuid (UUID):
        profile_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reorder_node_response_dto_response_item_config_profile_active_inbounds_item = cls(
            uuid=uuid,
        ...
        reorder_node_response_dto_response_item_config_profile_active_inbounds_item.additional_properties = d
        return reorder_node_response_dto_response_item_config_profile_active_inbounds_item
