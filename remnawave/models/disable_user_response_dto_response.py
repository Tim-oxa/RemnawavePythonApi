...
from ..models.disable_user_response_dto_response_status import DisableUserResponseDtoResponseStatus
from ..models.disable_user_response_dto_response_traffic_limit_strategy import (
    DisableUserResponseDtoResponseTrafficLimitStrategy,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.disable_user_response_dto_response_active_internal_squads_item import (
        DisableUserResponseDtoResponseActiveInternalSquadsItem,
    )
    from ..models.disable_user_response_dto_response_happ import DisableUserResponseDtoResponseHapp
    from ..models.disable_user_response_dto_response_last_connected_node_type_0 import (
        DisableUserResponseDtoResponseLastConnectedNodeType0,
    )


T = TypeVar("T", bound="DisableUserResponseDtoResponse")


@_attrs_define
class DisableUserResponseDtoResponse:
    """
    Attributes:
        uuid (UUID):
        short_uuid (str):
        ...
        active_internal_squads (list['DisableUserResponseDtoResponseActiveInternalSquadsItem']):
        subscription_url (str):
        last_connected_node (Union['DisableUserResponseDtoResponseLastConnectedNodeType0', None]):
        happ (DisableUserResponseDtoResponseHapp):
        status (Union[Unset, DisableUserResponseDtoResponseStatus]):  Default:
            DisableUserResponseDtoResponseStatus.ACTIVE.
        traffic_limit_bytes (Union[Unset, int]):  Default: 0.
        traffic_limit_strategy (Union[Unset, DisableUserResponseDtoResponseTrafficLimitStrategy]): Available reset
            periods Default: DisableUserResponseDtoResponseTrafficLimitStrategy.NO_RESET.
    ...
    last_connected_node: Union["DisableUserResponseDtoResponseLastConnectedNodeType0", None]
    happ: "DisableUserResponseDtoResponseHapp"
    status: Union[Unset, DisableUserResponseDtoResponseStatus] = DisableUserResponseDtoResponseStatus.ACTIVE
    traffic_limit_bytes: Union[Unset, int] = 0
    traffic_limit_strategy: Union[Unset, DisableUserResponseDtoResponseTrafficLimitStrategy] = (
        DisableUserResponseDtoResponseTrafficLimitStrategy.NO_RESET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.last_connected_node, DisableUserResponseDtoResponseLastConnectedNodeType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_internal_squads_item_data in _active_internal_squads:
            active_internal_squads_item = DisableUserResponseDtoResponseActiveInternalSquadsItem.from_dict(
        ...
        def _parse_last_connected_node(
            data: object,
        ) -> Union["DisableUserResponseDtoResponseLastConnectedNodeType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_connected_node_type_0 = DisableUserResponseDtoResponseLastConnectedNodeType0.from_dict(data)

                return last_connected_node_type_0
            except:  # noqa: E722
                pass
            return cast(Union["DisableUserResponseDtoResponseLastConnectedNodeType0", None], data)

        last_connected_node = _parse_last_connected_node(d.pop("lastConnectedNode"))

        happ = DisableUserResponseDtoResponseHapp.from_dict(d.pop("happ"))

        _status = d.pop("status", UNSET)
        status: Union[Unset, DisableUserResponseDtoResponseStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = DisableUserResponseDtoResponseStatus(_status)
        ...
        if isinstance(_traffic_limit_strategy, Unset):
            ...
            traffic_limit_strategy = DisableUserResponseDtoResponseTrafficLimitStrategy(_traffic_limit_strategy)

        last_triggered_threshold = d.pop("lastTriggeredThreshold", UNSET)

        disable_user_response_dto_response = cls(
            uuid=uuid,
        ...
        disable_user_response_dto_response.additional_properties = d
        return disable_user_response_dto_response
