...
T = TypeVar("T", bound="CreateNodeRequestDtoConfigProfile")


@_attrs_define
class CreateNodeRequestDtoConfigProfile:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_node_request_dto_config_profile = cls(
            active_config_profile_uuid=active_config_profile_uuid,
            active_inbounds=active_inbounds,
        )

        create_node_request_dto_config_profile.additional_properties = d
        return create_node_request_dto_config_profile
