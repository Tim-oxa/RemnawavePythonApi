...
from ..models.bulk_update_users_request_dto_fields_status import BulkUpdateUsersRequestDtoFieldsStatus
from ..models.bulk_update_users_request_dto_fields_traffic_limit_strategy import (
    BulkUpdateUsersRequestDtoFieldsTrafficLimitStrategy,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkUpdateUsersRequestDtoFields")


@_attrs_define
class BulkUpdateUsersRequestDtoFields:
    """
    Attributes:
        status (Union[Unset, BulkUpdateUsersRequestDtoFieldsStatus]):  Default:
            BulkUpdateUsersRequestDtoFieldsStatus.ACTIVE.
        traffic_limit_bytes (Union[Unset, int]): Traffic limit in bytes. 0 - unlimited
        traffic_limit_strategy (Union[Unset, BulkUpdateUsersRequestDtoFieldsTrafficLimitStrategy]): Traffic limit reset
            strategy
    ...
    status: Union[Unset, BulkUpdateUsersRequestDtoFieldsStatus] = BulkUpdateUsersRequestDtoFieldsStatus.ACTIVE
    traffic_limit_bytes: Union[Unset, int] = UNSET
    traffic_limit_strategy: Union[Unset, BulkUpdateUsersRequestDtoFieldsTrafficLimitStrategy] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, BulkUpdateUsersRequestDtoFieldsStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = BulkUpdateUsersRequestDtoFieldsStatus(_status)

        traffic_limit_bytes = d.pop("trafficLimitBytes", UNSET)

        _traffic_limit_strategy = d.pop("trafficLimitStrategy", UNSET)
        traffic_limit_strategy: Union[Unset, BulkUpdateUsersRequestDtoFieldsTrafficLimitStrategy]
        if isinstance(_traffic_limit_strategy, Unset):
            traffic_limit_strategy = UNSET
        else:
            traffic_limit_strategy = BulkUpdateUsersRequestDtoFieldsTrafficLimitStrategy(_traffic_limit_strategy)
        ...
        bulk_update_users_request_dto_fields = cls(
            status=status,
        ...
        bulk_update_users_request_dto_fields.additional_properties = d
        return bulk_update_users_request_dto_fields
