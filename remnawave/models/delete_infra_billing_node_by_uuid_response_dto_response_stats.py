...
T = TypeVar("T", bound="DeleteInfraBillingNodeByUuidResponseDtoResponseStats")


@_attrs_define
class DeleteInfraBillingNodeByUuidResponseDtoResponseStats:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_infra_billing_node_by_uuid_response_dto_response_stats = cls(
            upcoming_nodes_count=upcoming_nodes_count,
            current_month_payments=current_month_payments,
            total_spent=total_spent,
        )

        delete_infra_billing_node_by_uuid_response_dto_response_stats.additional_properties = d
        return delete_infra_billing_node_by_uuid_response_dto_response_stats
