...
T = TypeVar("T", bound="GetConfigProfileByUuidResponseDtoResponseInboundsItem")


@_attrs_define
class GetConfigProfileByUuidResponseDtoResponseInboundsItem:
    """
    Attributes:
        uuid (UUID):
        profile_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_config_profile_by_uuid_response_dto_response_inbounds_item = cls(
            uuid=uuid,
        ...
        get_config_profile_by_uuid_response_dto_response_inbounds_item.additional_properties = d
        return get_config_profile_by_uuid_response_dto_response_inbounds_item
