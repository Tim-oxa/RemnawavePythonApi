...
from ..models.set_inbound_to_many_hosts_response_dto_response_item_security_layer import (
    SetInboundToManyHostsResponseDtoResponseItemSecurityLayer,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.set_inbound_to_many_hosts_response_dto_response_item_inbound import (
        SetInboundToManyHostsResponseDtoResponseItemInbound,
    )


T = TypeVar("T", bound="SetInboundToManyHostsResponseDtoResponseItem")


@_attrs_define
class SetInboundToManyHostsResponseDtoResponseItem:
    """
    Attributes:
        uuid (UUID):
        view_position (int):
        ...
        mux_params (Any):
        sockopt_params (Any):
        inbound (SetInboundToManyHostsResponseDtoResponseItemInbound):
        server_description (Union[None, str]):
        tag (Union[None, str]):
        is_disabled (Union[Unset, bool]):  Default: False.
        security_layer (Union[Unset, SetInboundToManyHostsResponseDtoResponseItemSecurityLayer]):  Default:
            SetInboundToManyHostsResponseDtoResponseItemSecurityLayer.DEFAULT.
    ...
    security_layer: Union[Unset, SetInboundToManyHostsResponseDtoResponseItemSecurityLayer] = (
        SetInboundToManyHostsResponseDtoResponseItemSecurityLayer.DEFAULT
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inbound = SetInboundToManyHostsResponseDtoResponseItemInbound.from_dict(d.pop("inbound"))
        ...
        if isinstance(_security_layer, Unset):
            ...
            security_layer = SetInboundToManyHostsResponseDtoResponseItemSecurityLayer(_security_layer)

        is_hidden = d.pop("isHidden", UNSET)

        override_sni_from_address = d.pop("overrideSniFromAddress", UNSET)

        set_inbound_to_many_hosts_response_dto_response_item = cls(
            uuid=uuid,
        ...
        set_inbound_to_many_hosts_response_dto_response_item.additional_properties = d
        return set_inbound_to_many_hosts_response_dto_response_item
