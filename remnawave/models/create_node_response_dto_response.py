...
if TYPE_CHECKING:
    from ..models.create_node_response_dto_response_config_profile import CreateNodeResponseDtoResponseConfigProfile
    from ..models.create_node_response_dto_response_provider_type_0 import CreateNodeResponseDtoResponseProviderType0


T = TypeVar("T", bound="CreateNodeResponseDtoResponse")


@_attrs_define
class CreateNodeResponseDtoResponse:
    """
    Attributes:
        uuid (UUID):
        name (str):
        ...
        config_profile (CreateNodeResponseDtoResponseConfigProfile):
        provider_uuid (Union[None, UUID]):
        provider (Union['CreateNodeResponseDtoResponseProviderType0', None]):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.create_node_response_dto_response_provider_type_0 import (
        ...
        if isinstance(self.provider, CreateNodeResponseDtoResponseProviderType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config_profile = CreateNodeResponseDtoResponseConfigProfile.from_dict(d.pop("configProfile"))
        ...
        def _parse_provider(data: object) -> Union["CreateNodeResponseDtoResponseProviderType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                provider_type_0 = CreateNodeResponseDtoResponseProviderType0.from_dict(data)

                return provider_type_0
            except:  # noqa: E722
                pass
            return cast(Union["CreateNodeResponseDtoResponseProviderType0", None], data)

        provider = _parse_provider(d.pop("provider"))

        create_node_response_dto_response = cls(
            uuid=uuid,
            name=name,
            address=address,
            port=port,
        ...
        create_node_response_dto_response.additional_properties = d
        return create_node_response_dto_response
