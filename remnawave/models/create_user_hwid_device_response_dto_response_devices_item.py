...
T = TypeVar("T", bound="CreateUserHwidDeviceResponseDtoResponseDevicesItem")


@_attrs_define
class CreateUserHwidDeviceResponseDtoResponseDevicesItem:
    """
    Attributes:
        hwid (str):
        user_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_user_hwid_device_response_dto_response_devices_item = cls(
            hwid=hwid,
            user_uuid=user_uuid,
            platform=platform,
        ...
        create_user_hwid_device_response_dto_response_devices_item.additional_properties = d
        return create_user_hwid_device_response_dto_response_devices_item
