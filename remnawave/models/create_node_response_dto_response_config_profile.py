...
if TYPE_CHECKING:
    from ..models.create_node_response_dto_response_config_profile_active_inbounds_item import (
        CreateNodeResponseDtoResponseConfigProfileActiveInboundsItem,
    )


T = TypeVar("T", bound="CreateNodeResponseDtoResponseConfigProfile")


@_attrs_define
class CreateNodeResponseDtoResponseConfigProfile:
    """
    Attributes:
        active_config_profile_uuid (Union[None, UUID]):
        active_inbounds (list['CreateNodeResponseDtoResponseConfigProfileActiveInboundsItem']):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_inbounds_item_data in _active_inbounds:
            active_inbounds_item = CreateNodeResponseDtoResponseConfigProfileActiveInboundsItem.from_dict(
                active_inbounds_item_data
            )

            active_inbounds.append(active_inbounds_item)

        create_node_response_dto_response_config_profile = cls(
            active_config_profile_uuid=active_config_profile_uuid,
            active_inbounds=active_inbounds,
        )

        create_node_response_dto_response_config_profile.additional_properties = d
        return create_node_response_dto_response_config_profile
