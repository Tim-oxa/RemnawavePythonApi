...
from ..models.bulk_enable_hosts_response_dto_response_item_security_layer import (
    BulkEnableHostsResponseDtoResponseItemSecurityLayer,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.bulk_enable_hosts_response_dto_response_item_inbound import (
        BulkEnableHostsResponseDtoResponseItemInbound,
    )


T = TypeVar("T", bound="BulkEnableHostsResponseDtoResponseItem")


@_attrs_define
class BulkEnableHostsResponseDtoResponseItem:
    """
    Attributes:
        uuid (UUID):
        view_position (int):
        ...
        mux_params (Any):
        sockopt_params (Any):
        inbound (BulkEnableHostsResponseDtoResponseItemInbound):
        server_description (Union[None, str]):
        tag (Union[None, str]):
        is_disabled (Union[Unset, bool]):  Default: False.
        security_layer (Union[Unset, BulkEnableHostsResponseDtoResponseItemSecurityLayer]):  Default:
            BulkEnableHostsResponseDtoResponseItemSecurityLayer.DEFAULT.
    ...
    security_layer: Union[Unset, BulkEnableHostsResponseDtoResponseItemSecurityLayer] = (
        BulkEnableHostsResponseDtoResponseItemSecurityLayer.DEFAULT
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inbound = BulkEnableHostsResponseDtoResponseItemInbound.from_dict(d.pop("inbound"))
        ...
        if isinstance(_security_layer, Unset):
            ...
            security_layer = BulkEnableHostsResponseDtoResponseItemSecurityLayer(_security_layer)

        is_hidden = d.pop("isHidden", UNSET)

        override_sni_from_address = d.pop("overrideSniFromAddress", UNSET)

        bulk_enable_hosts_response_dto_response_item = cls(
            uuid=uuid,
        ...
        bulk_enable_hosts_response_dto_response_item.additional_properties = d
        return bulk_enable_hosts_response_dto_response_item
