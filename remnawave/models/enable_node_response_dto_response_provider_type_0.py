...
T = TypeVar("T", bound="EnableNodeResponseDtoResponseProviderType0")


@_attrs_define
class EnableNodeResponseDtoResponseProviderType0:
    """
    Attributes:
        uuid (UUID):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        enable_node_response_dto_response_provider_type_0 = cls(
            uuid=uuid,
            name=name,
        ...
        enable_node_response_dto_response_provider_type_0.additional_properties = d
        return enable_node_response_dto_response_provider_type_0
