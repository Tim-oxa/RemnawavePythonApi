...
if TYPE_CHECKING:
    from ..models.reorder_node_response_dto_response_item_config_profile_active_inbounds_item import (
        ReorderNodeResponseDtoResponseItemConfigProfileActiveInboundsItem,
    )


T = TypeVar("T", bound="ReorderNodeResponseDtoResponseItemConfigProfile")


@_attrs_define
class ReorderNodeResponseDtoResponseItemConfigProfile:
    """
    Attributes:
        active_config_profile_uuid (Union[None, UUID]):
        active_inbounds (list['ReorderNodeResponseDtoResponseItemConfigProfileActiveInboundsItem']):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_inbounds_item_data in _active_inbounds:
            active_inbounds_item = ReorderNodeResponseDtoResponseItemConfigProfileActiveInboundsItem.from_dict(
                active_inbounds_item_data
            )

            active_inbounds.append(active_inbounds_item)

        reorder_node_response_dto_response_item_config_profile = cls(
            active_config_profile_uuid=active_config_profile_uuid,
            active_inbounds=active_inbounds,
        )

        reorder_node_response_dto_response_item_config_profile.additional_properties = d
        return reorder_node_response_dto_response_item_config_profile
