...
from ..models.get_user_by_tag_response_dto_response_item_status import GetUserByTagResponseDtoResponseItemStatus
from ..models.get_user_by_tag_response_dto_response_item_traffic_limit_strategy import (
    GetUserByTagResponseDtoResponseItemTrafficLimitStrategy,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_user_by_tag_response_dto_response_item_active_internal_squads_item import (
        GetUserByTagResponseDtoResponseItemActiveInternalSquadsItem,
    )
    from ..models.get_user_by_tag_response_dto_response_item_happ import GetUserByTagResponseDtoResponseItemHapp
    from ..models.get_user_by_tag_response_dto_response_item_last_connected_node_type_0 import (
        GetUserByTagResponseDtoResponseItemLastConnectedNodeType0,
    )


T = TypeVar("T", bound="GetUserByTagResponseDtoResponseItem")


@_attrs_define
class GetUserByTagResponseDtoResponseItem:
    """
    Attributes:
        uuid (UUID):
        short_uuid (str):
        ...
        active_internal_squads (list['GetUserByTagResponseDtoResponseItemActiveInternalSquadsItem']):
        subscription_url (str):
        last_connected_node (Union['GetUserByTagResponseDtoResponseItemLastConnectedNodeType0', None]):
        happ (GetUserByTagResponseDtoResponseItemHapp):
        status (Union[Unset, GetUserByTagResponseDtoResponseItemStatus]):  Default:
            GetUserByTagResponseDtoResponseItemStatus.ACTIVE.
        traffic_limit_bytes (Union[Unset, int]):  Default: 0.
        traffic_limit_strategy (Union[Unset, GetUserByTagResponseDtoResponseItemTrafficLimitStrategy]): Available reset
            periods Default: GetUserByTagResponseDtoResponseItemTrafficLimitStrategy.NO_RESET.
    ...
    last_connected_node: Union["GetUserByTagResponseDtoResponseItemLastConnectedNodeType0", None]
    happ: "GetUserByTagResponseDtoResponseItemHapp"
    status: Union[Unset, GetUserByTagResponseDtoResponseItemStatus] = GetUserByTagResponseDtoResponseItemStatus.ACTIVE
    traffic_limit_bytes: Union[Unset, int] = 0
    traffic_limit_strategy: Union[Unset, GetUserByTagResponseDtoResponseItemTrafficLimitStrategy] = (
        GetUserByTagResponseDtoResponseItemTrafficLimitStrategy.NO_RESET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.last_connected_node, GetUserByTagResponseDtoResponseItemLastConnectedNodeType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_internal_squads_item_data in _active_internal_squads:
            active_internal_squads_item = GetUserByTagResponseDtoResponseItemActiveInternalSquadsItem.from_dict(
        ...
        def _parse_last_connected_node(
            data: object,
        ) -> Union["GetUserByTagResponseDtoResponseItemLastConnectedNodeType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_connected_node_type_0 = GetUserByTagResponseDtoResponseItemLastConnectedNodeType0.from_dict(data)

                return last_connected_node_type_0
            except:  # noqa: E722
                pass
            return cast(Union["GetUserByTagResponseDtoResponseItemLastConnectedNodeType0", None], data)

        last_connected_node = _parse_last_connected_node(d.pop("lastConnectedNode"))

        happ = GetUserByTagResponseDtoResponseItemHapp.from_dict(d.pop("happ"))

        _status = d.pop("status", UNSET)
        status: Union[Unset, GetUserByTagResponseDtoResponseItemStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = GetUserByTagResponseDtoResponseItemStatus(_status)
        ...
        if isinstance(_traffic_limit_strategy, Unset):
            ...
            traffic_limit_strategy = GetUserByTagResponseDtoResponseItemTrafficLimitStrategy(_traffic_limit_strategy)

        last_triggered_threshold = d.pop("lastTriggeredThreshold", UNSET)

        get_user_by_tag_response_dto_response_item = cls(
            uuid=uuid,
        ...
        get_user_by_tag_response_dto_response_item.additional_properties = d
        return get_user_by_tag_response_dto_response_item
