...
from ..models.get_all_hosts_response_dto_response_item_security_layer import (
    GetAllHostsResponseDtoResponseItemSecurityLayer,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_all_hosts_response_dto_response_item_inbound import GetAllHostsResponseDtoResponseItemInbound


T = TypeVar("T", bound="GetAllHostsResponseDtoResponseItem")


@_attrs_define
class GetAllHostsResponseDtoResponseItem:
    """
    Attributes:
        uuid (UUID):
        view_position (int):
        ...
        mux_params (Any):
        sockopt_params (Any):
        inbound (GetAllHostsResponseDtoResponseItemInbound):
        server_description (Union[None, str]):
        tag (Union[None, str]):
        is_disabled (Union[Unset, bool]):  Default: False.
        security_layer (Union[Unset, GetAllHostsResponseDtoResponseItemSecurityLayer]):  Default:
            GetAllHostsResponseDtoResponseItemSecurityLayer.DEFAULT.
    ...
    security_layer: Union[Unset, GetAllHostsResponseDtoResponseItemSecurityLayer] = (
        GetAllHostsResponseDtoResponseItemSecurityLayer.DEFAULT
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inbound = GetAllHostsResponseDtoResponseItemInbound.from_dict(d.pop("inbound"))
        ...
        if isinstance(_security_layer, Unset):
            ...
            security_layer = GetAllHostsResponseDtoResponseItemSecurityLayer(_security_layer)

        is_hidden = d.pop("isHidden", UNSET)

        override_sni_from_address = d.pop("overrideSniFromAddress", UNSET)

        get_all_hosts_response_dto_response_item = cls(
            uuid=uuid,
        ...
        get_all_hosts_response_dto_response_item.additional_properties = d
        return get_all_hosts_response_dto_response_item
