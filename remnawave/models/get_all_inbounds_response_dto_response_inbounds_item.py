...
T = TypeVar("T", bound="GetAllInboundsResponseDtoResponseInboundsItem")


@_attrs_define
class GetAllInboundsResponseDtoResponseInboundsItem:
    """
    Attributes:
        uuid (UUID):
        profile_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_all_inbounds_response_dto_response_inbounds_item = cls(
            uuid=uuid,
        ...
        get_all_inbounds_response_dto_response_inbounds_item.additional_properties = d
        return get_all_inbounds_response_dto_response_inbounds_item
