...
from ..models.get_user_by_email_response_dto_response_item_status import GetUserByEmailResponseDtoResponseItemStatus
from ..models.get_user_by_email_response_dto_response_item_traffic_limit_strategy import (
    GetUserByEmailResponseDtoResponseItemTrafficLimitStrategy,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_user_by_email_response_dto_response_item_active_internal_squads_item import (
        GetUserByEmailResponseDtoResponseItemActiveInternalSquadsItem,
    )
    from ..models.get_user_by_email_response_dto_response_item_happ import GetUserByEmailResponseDtoResponseItemHapp
    from ..models.get_user_by_email_response_dto_response_item_last_connected_node_type_0 import (
        GetUserByEmailResponseDtoResponseItemLastConnectedNodeType0,
    )


T = TypeVar("T", bound="GetUserByEmailResponseDtoResponseItem")


@_attrs_define
class GetUserByEmailResponseDtoResponseItem:
    """
    Attributes:
        uuid (UUID):
        short_uuid (str):
        ...
        active_internal_squads (list['GetUserByEmailResponseDtoResponseItemActiveInternalSquadsItem']):
        subscription_url (str):
        last_connected_node (Union['GetUserByEmailResponseDtoResponseItemLastConnectedNodeType0', None]):
        happ (GetUserByEmailResponseDtoResponseItemHapp):
        status (Union[Unset, GetUserByEmailResponseDtoResponseItemStatus]):  Default:
            GetUserByEmailResponseDtoResponseItemStatus.ACTIVE.
        traffic_limit_bytes (Union[Unset, int]):  Default: 0.
        traffic_limit_strategy (Union[Unset, GetUserByEmailResponseDtoResponseItemTrafficLimitStrategy]): Available
            reset periods Default: GetUserByEmailResponseDtoResponseItemTrafficLimitStrategy.NO_RESET.
    ...
    last_connected_node: Union["GetUserByEmailResponseDtoResponseItemLastConnectedNodeType0", None]
    happ: "GetUserByEmailResponseDtoResponseItemHapp"
    status: Union[Unset, GetUserByEmailResponseDtoResponseItemStatus] = (
        GetUserByEmailResponseDtoResponseItemStatus.ACTIVE
    )
    traffic_limit_bytes: Union[Unset, int] = 0
    traffic_limit_strategy: Union[Unset, GetUserByEmailResponseDtoResponseItemTrafficLimitStrategy] = (
        GetUserByEmailResponseDtoResponseItemTrafficLimitStrategy.NO_RESET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.last_connected_node, GetUserByEmailResponseDtoResponseItemLastConnectedNodeType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_internal_squads_item_data in _active_internal_squads:
            active_internal_squads_item = GetUserByEmailResponseDtoResponseItemActiveInternalSquadsItem.from_dict(
        ...
        def _parse_last_connected_node(
            data: object,
        ) -> Union["GetUserByEmailResponseDtoResponseItemLastConnectedNodeType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_connected_node_type_0 = GetUserByEmailResponseDtoResponseItemLastConnectedNodeType0.from_dict(data)

                return last_connected_node_type_0
            except:  # noqa: E722
                pass
            return cast(Union["GetUserByEmailResponseDtoResponseItemLastConnectedNodeType0", None], data)

        last_connected_node = _parse_last_connected_node(d.pop("lastConnectedNode"))

        happ = GetUserByEmailResponseDtoResponseItemHapp.from_dict(d.pop("happ"))
        ...
        if isinstance(_status, Unset):
            ...
            status = GetUserByEmailResponseDtoResponseItemStatus(_status)
        ...
        if isinstance(_traffic_limit_strategy, Unset):
            ...
            traffic_limit_strategy = GetUserByEmailResponseDtoResponseItemTrafficLimitStrategy(_traffic_limit_strategy)

        last_triggered_threshold = d.pop("lastTriggeredThreshold", UNSET)

        get_user_by_email_response_dto_response_item = cls(
            uuid=uuid,
        ...
        get_user_by_email_response_dto_response_item.additional_properties = d
        return get_user_by_email_response_dto_response_item
