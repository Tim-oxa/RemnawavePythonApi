...
T = TypeVar("T", bound="BulkDeleteHostsResponseDtoResponseItemInbound")


@_attrs_define
class BulkDeleteHostsResponseDtoResponseItemInbound:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_delete_hosts_response_dto_response_item_inbound = cls(
            config_profile_uuid=config_profile_uuid,
            config_profile_inbound_uuid=config_profile_inbound_uuid,
        )

        bulk_delete_hosts_response_dto_response_item_inbound.additional_properties = d
        return bulk_delete_hosts_response_dto_response_item_inbound
