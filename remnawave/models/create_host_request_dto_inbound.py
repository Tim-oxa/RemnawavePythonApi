...
T = TypeVar("T", bound="CreateHostRequestDtoInbound")


@_attrs_define
class CreateHostRequestDtoInbound:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_host_request_dto_inbound = cls(
            config_profile_uuid=config_profile_uuid,
            config_profile_inbound_uuid=config_profile_inbound_uuid,
        )

        create_host_request_dto_inbound.additional_properties = d
        return create_host_request_dto_inbound
