...
if TYPE_CHECKING:
    from ..models.get_one_node_response_dto_response_config_profile_active_inbounds_item import (
        GetOneNodeResponseDtoResponseConfigProfileActiveInboundsItem,
    )


T = TypeVar("T", bound="GetOneNodeResponseDtoResponseConfigProfile")


@_attrs_define
class GetOneNodeResponseDtoResponseConfigProfile:
    """
    Attributes:
        active_config_profile_uuid (Union[None, UUID]):
        active_inbounds (list['GetOneNodeResponseDtoResponseConfigProfileActiveInboundsItem']):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_inbounds_item_data in _active_inbounds:
            active_inbounds_item = GetOneNodeResponseDtoResponseConfigProfileActiveInboundsItem.from_dict(
                active_inbounds_item_data
            )

            active_inbounds.append(active_inbounds_item)

        get_one_node_response_dto_response_config_profile = cls(
            active_config_profile_uuid=active_config_profile_uuid,
            active_inbounds=active_inbounds,
        )

        get_one_node_response_dto_response_config_profile.additional_properties = d
        return get_one_node_response_dto_response_config_profile
