...
from ..models.create_user_response_dto_response_status import CreateUserResponseDtoResponseStatus
from ..models.create_user_response_dto_response_traffic_limit_strategy import (
    CreateUserResponseDtoResponseTrafficLimitStrategy,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.create_user_response_dto_response_active_internal_squads_item import (
        CreateUserResponseDtoResponseActiveInternalSquadsItem,
    )
    from ..models.create_user_response_dto_response_happ import CreateUserResponseDtoResponseHapp
    from ..models.create_user_response_dto_response_last_connected_node_type_0 import (
        CreateUserResponseDtoResponseLastConnectedNodeType0,
    )


T = TypeVar("T", bound="CreateUserResponseDtoResponse")


@_attrs_define
class CreateUserResponseDtoResponse:
    """
    Attributes:
        uuid (UUID):
        short_uuid (str):
        ...
        active_internal_squads (list['CreateUserResponseDtoResponseActiveInternalSquadsItem']):
        subscription_url (str):
        last_connected_node (Union['CreateUserResponseDtoResponseLastConnectedNodeType0', None]):
        happ (CreateUserResponseDtoResponseHapp):
        status (Union[Unset, CreateUserResponseDtoResponseStatus]):  Default:
            CreateUserResponseDtoResponseStatus.ACTIVE.
        traffic_limit_bytes (Union[Unset, int]):  Default: 0.
        traffic_limit_strategy (Union[Unset, CreateUserResponseDtoResponseTrafficLimitStrategy]): Available reset
            periods Default: CreateUserResponseDtoResponseTrafficLimitStrategy.NO_RESET.
    ...
    last_connected_node: Union["CreateUserResponseDtoResponseLastConnectedNodeType0", None]
    happ: "CreateUserResponseDtoResponseHapp"
    status: Union[Unset, CreateUserResponseDtoResponseStatus] = CreateUserResponseDtoResponseStatus.ACTIVE
    traffic_limit_bytes: Union[Unset, int] = 0
    traffic_limit_strategy: Union[Unset, CreateUserResponseDtoResponseTrafficLimitStrategy] = (
        CreateUserResponseDtoResponseTrafficLimitStrategy.NO_RESET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.last_connected_node, CreateUserResponseDtoResponseLastConnectedNodeType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_internal_squads_item_data in _active_internal_squads:
            active_internal_squads_item = CreateUserResponseDtoResponseActiveInternalSquadsItem.from_dict(
        ...
        def _parse_last_connected_node(
            data: object,
        ) -> Union["CreateUserResponseDtoResponseLastConnectedNodeType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_connected_node_type_0 = CreateUserResponseDtoResponseLastConnectedNodeType0.from_dict(data)

                return last_connected_node_type_0
            except:  # noqa: E722
                pass
            return cast(Union["CreateUserResponseDtoResponseLastConnectedNodeType0", None], data)

        last_connected_node = _parse_last_connected_node(d.pop("lastConnectedNode"))

        happ = CreateUserResponseDtoResponseHapp.from_dict(d.pop("happ"))

        _status = d.pop("status", UNSET)
        status: Union[Unset, CreateUserResponseDtoResponseStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = CreateUserResponseDtoResponseStatus(_status)
        ...
        if isinstance(_traffic_limit_strategy, Unset):
            ...
            traffic_limit_strategy = CreateUserResponseDtoResponseTrafficLimitStrategy(_traffic_limit_strategy)

        last_triggered_threshold = d.pop("lastTriggeredThreshold", UNSET)

        create_user_response_dto_response = cls(
            uuid=uuid,
        ...
        create_user_response_dto_response.additional_properties = d
        return create_user_response_dto_response
