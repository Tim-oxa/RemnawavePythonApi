...
from ..models.bulk_all_update_users_request_dto_status import BulkAllUpdateUsersRequestDtoStatus
from ..models.bulk_all_update_users_request_dto_traffic_limit_strategy import (
    BulkAllUpdateUsersRequestDtoTrafficLimitStrategy,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkAllUpdateUsersRequestDto")
...
class BulkAllUpdateUsersRequestDto:
    """
    Attributes:
        status (Union[Unset, BulkAllUpdateUsersRequestDtoStatus]):  Default: BulkAllUpdateUsersRequestDtoStatus.ACTIVE.
        traffic_limit_bytes (Union[Unset, int]): Traffic limit in bytes. 0 - unlimited
        traffic_limit_strategy (Union[Unset, BulkAllUpdateUsersRequestDtoTrafficLimitStrategy]): Traffic limit reset
            strategy
    ...
    status: Union[Unset, BulkAllUpdateUsersRequestDtoStatus] = BulkAllUpdateUsersRequestDtoStatus.ACTIVE
    traffic_limit_bytes: Union[Unset, int] = UNSET
    traffic_limit_strategy: Union[Unset, BulkAllUpdateUsersRequestDtoTrafficLimitStrategy] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, BulkAllUpdateUsersRequestDtoStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = BulkAllUpdateUsersRequestDtoStatus(_status)

        traffic_limit_bytes = d.pop("trafficLimitBytes", UNSET)

        _traffic_limit_strategy = d.pop("trafficLimitStrategy", UNSET)
        traffic_limit_strategy: Union[Unset, BulkAllUpdateUsersRequestDtoTrafficLimitStrategy]
        if isinstance(_traffic_limit_strategy, Unset):
            traffic_limit_strategy = UNSET
        else:
            traffic_limit_strategy = BulkAllUpdateUsersRequestDtoTrafficLimitStrategy(_traffic_limit_strategy)
        ...
        bulk_all_update_users_request_dto = cls(
            status=status,
        ...
        bulk_all_update_users_request_dto.additional_properties = d
        return bulk_all_update_users_request_dto
