...
from ..models.bulk_disable_hosts_response_dto_response_item_security_layer import (
    BulkDisableHostsResponseDtoResponseItemSecurityLayer,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.bulk_disable_hosts_response_dto_response_item_inbound import (
        BulkDisableHostsResponseDtoResponseItemInbound,
    )


T = TypeVar("T", bound="BulkDisableHostsResponseDtoResponseItem")


@_attrs_define
class BulkDisableHostsResponseDtoResponseItem:
    """
    Attributes:
        uuid (UUID):
        view_position (int):
        ...
        mux_params (Any):
        sockopt_params (Any):
        inbound (BulkDisableHostsResponseDtoResponseItemInbound):
        server_description (Union[None, str]):
        tag (Union[None, str]):
        is_disabled (Union[Unset, bool]):  Default: False.
        security_layer (Union[Unset, BulkDisableHostsResponseDtoResponseItemSecurityLayer]):  Default:
            BulkDisableHostsResponseDtoResponseItemSecurityLayer.DEFAULT.
    ...
    security_layer: Union[Unset, BulkDisableHostsResponseDtoResponseItemSecurityLayer] = (
        BulkDisableHostsResponseDtoResponseItemSecurityLayer.DEFAULT
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inbound = BulkDisableHostsResponseDtoResponseItemInbound.from_dict(d.pop("inbound"))
        ...
        if isinstance(_security_layer, Unset):
            ...
            security_layer = BulkDisableHostsResponseDtoResponseItemSecurityLayer(_security_layer)

        is_hidden = d.pop("isHidden", UNSET)

        override_sni_from_address = d.pop("overrideSniFromAddress", UNSET)

        bulk_disable_hosts_response_dto_response_item = cls(
            uuid=uuid,
        ...
        bulk_disable_hosts_response_dto_response_item.additional_properties = d
        return bulk_disable_hosts_response_dto_response_item
