...
T = TypeVar("T", bound="CreateNodeResponseDtoResponseProviderType0")


@_attrs_define
class CreateNodeResponseDtoResponseProviderType0:
    """
    Attributes:
        uuid (UUID):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_node_response_dto_response_provider_type_0 = cls(
            uuid=uuid,
            name=name,
        ...
        create_node_response_dto_response_provider_type_0.additional_properties = d
        return create_node_response_dto_response_provider_type_0
