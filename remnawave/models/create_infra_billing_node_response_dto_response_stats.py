...
T = TypeVar("T", bound="CreateInfraBillingNodeResponseDtoResponseStats")


@_attrs_define
class CreateInfraBillingNodeResponseDtoResponseStats:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_infra_billing_node_response_dto_response_stats = cls(
            upcoming_nodes_count=upcoming_nodes_count,
            current_month_payments=current_month_payments,
            total_spent=total_spent,
        )

        create_infra_billing_node_response_dto_response_stats.additional_properties = d
        return create_infra_billing_node_response_dto_response_stats
