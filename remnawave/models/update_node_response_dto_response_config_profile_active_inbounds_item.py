...
T = TypeVar("T", bound="UpdateNodeResponseDtoResponseConfigProfileActiveInboundsItem")


@_attrs_define
class UpdateNodeResponseDtoResponseConfigProfileActiveInboundsItem:
    """
    Attributes:
        uuid (UUID):
        profile_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_node_response_dto_response_config_profile_active_inbounds_item = cls(
            uuid=uuid,
        ...
        update_node_response_dto_response_config_profile_active_inbounds_item.additional_properties = d
        return update_node_response_dto_response_config_profile_active_inbounds_item
