...
T = TypeVar("T", bound="CreateHostResponseDtoResponseInbound")


@_attrs_define
class CreateHostResponseDtoResponseInbound:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_host_response_dto_response_inbound = cls(
            config_profile_uuid=config_profile_uuid,
            config_profile_inbound_uuid=config_profile_inbound_uuid,
        )

        create_host_response_dto_response_inbound.additional_properties = d
        return create_host_response_dto_response_inbound
