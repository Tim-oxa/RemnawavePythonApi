...
if TYPE_CHECKING:
    from ..models.enable_node_response_dto_response_config_profile import EnableNodeResponseDtoResponseConfigProfile
    from ..models.enable_node_response_dto_response_provider_type_0 import EnableNodeResponseDtoResponseProviderType0


T = TypeVar("T", bound="EnableNodeResponseDtoResponse")


@_attrs_define
class EnableNodeResponseDtoResponse:
    """
    Attributes:
        uuid (UUID):
        name (str):
        ...
        config_profile (EnableNodeResponseDtoResponseConfigProfile):
        provider_uuid (Union[None, UUID]):
        provider (Union['EnableNodeResponseDtoResponseProviderType0', None]):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.enable_node_response_dto_response_provider_type_0 import (
        ...
        if isinstance(self.provider, EnableNodeResponseDtoResponseProviderType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config_profile = EnableNodeResponseDtoResponseConfigProfile.from_dict(d.pop("configProfile"))
        ...
        def _parse_provider(data: object) -> Union["EnableNodeResponseDtoResponseProviderType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                provider_type_0 = EnableNodeResponseDtoResponseProviderType0.from_dict(data)

                return provider_type_0
            except:  # noqa: E722
                pass
            return cast(Union["EnableNodeResponseDtoResponseProviderType0", None], data)

        provider = _parse_provider(d.pop("provider"))

        enable_node_response_dto_response = cls(
            uuid=uuid,
            name=name,
            address=address,
            port=port,
        ...
        enable_node_response_dto_response.additional_properties = d
        return enable_node_response_dto_response
