...
from ..models.set_port_to_many_hosts_response_dto_response_item_security_layer import (
    SetPortToManyHostsResponseDtoResponseItemSecurityLayer,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.set_port_to_many_hosts_response_dto_response_item_inbound import (
        SetPortToManyHostsResponseDtoResponseItemInbound,
    )


T = TypeVar("T", bound="SetPortToManyHostsResponseDtoResponseItem")


@_attrs_define
class SetPortToManyHostsResponseDtoResponseItem:
    """
    Attributes:
        uuid (UUID):
        view_position (int):
        ...
        mux_params (Any):
        sockopt_params (Any):
        inbound (SetPortToManyHostsResponseDtoResponseItemInbound):
        server_description (Union[None, str]):
        tag (Union[None, str]):
        is_disabled (Union[Unset, bool]):  Default: False.
        security_layer (Union[Unset, SetPortToManyHostsResponseDtoResponseItemSecurityLayer]):  Default:
            SetPortToManyHostsResponseDtoResponseItemSecurityLayer.DEFAULT.
    ...
    security_layer: Union[Unset, SetPortToManyHostsResponseDtoResponseItemSecurityLayer] = (
        SetPortToManyHostsResponseDtoResponseItemSecurityLayer.DEFAULT
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inbound = SetPortToManyHostsResponseDtoResponseItemInbound.from_dict(d.pop("inbound"))
        ...
        if isinstance(_security_layer, Unset):
            ...
            security_layer = SetPortToManyHostsResponseDtoResponseItemSecurityLayer(_security_layer)

        is_hidden = d.pop("isHidden", UNSET)

        override_sni_from_address = d.pop("overrideSniFromAddress", UNSET)

        set_port_to_many_hosts_response_dto_response_item = cls(
            uuid=uuid,
        ...
        set_port_to_many_hosts_response_dto_response_item.additional_properties = d
        return set_port_to_many_hosts_response_dto_response_item
