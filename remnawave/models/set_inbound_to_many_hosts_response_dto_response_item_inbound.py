...
T = TypeVar("T", bound="SetInboundToManyHostsResponseDtoResponseItemInbound")


@_attrs_define
class SetInboundToManyHostsResponseDtoResponseItemInbound:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        set_inbound_to_many_hosts_response_dto_response_item_inbound = cls(
            config_profile_uuid=config_profile_uuid,
            config_profile_inbound_uuid=config_profile_inbound_uuid,
        )

        set_inbound_to_many_hosts_response_dto_response_item_inbound.additional_properties = d
        return set_inbound_to_many_hosts_response_dto_response_item_inbound
