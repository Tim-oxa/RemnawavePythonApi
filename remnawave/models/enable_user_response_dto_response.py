...
from ..models.enable_user_response_dto_response_status import EnableUserResponseDtoResponseStatus
from ..models.enable_user_response_dto_response_traffic_limit_strategy import (
    EnableUserResponseDtoResponseTrafficLimitStrategy,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.enable_user_response_dto_response_active_internal_squads_item import (
        EnableUserResponseDtoResponseActiveInternalSquadsItem,
    )
    from ..models.enable_user_response_dto_response_happ import EnableUserResponseDtoResponseHapp
    from ..models.enable_user_response_dto_response_last_connected_node_type_0 import (
        EnableUserResponseDtoResponseLastConnectedNodeType0,
    )


T = TypeVar("T", bound="EnableUserResponseDtoResponse")


@_attrs_define
class EnableUserResponseDtoResponse:
    """
    Attributes:
        uuid (UUID):
        short_uuid (str):
        ...
        active_internal_squads (list['EnableUserResponseDtoResponseActiveInternalSquadsItem']):
        subscription_url (str):
        last_connected_node (Union['EnableUserResponseDtoResponseLastConnectedNodeType0', None]):
        happ (EnableUserResponseDtoResponseHapp):
        status (Union[Unset, EnableUserResponseDtoResponseStatus]):  Default:
            EnableUserResponseDtoResponseStatus.ACTIVE.
        traffic_limit_bytes (Union[Unset, int]):  Default: 0.
        traffic_limit_strategy (Union[Unset, EnableUserResponseDtoResponseTrafficLimitStrategy]): Available reset
            periods Default: EnableUserResponseDtoResponseTrafficLimitStrategy.NO_RESET.
    ...
    last_connected_node: Union["EnableUserResponseDtoResponseLastConnectedNodeType0", None]
    happ: "EnableUserResponseDtoResponseHapp"
    status: Union[Unset, EnableUserResponseDtoResponseStatus] = EnableUserResponseDtoResponseStatus.ACTIVE
    traffic_limit_bytes: Union[Unset, int] = 0
    traffic_limit_strategy: Union[Unset, EnableUserResponseDtoResponseTrafficLimitStrategy] = (
        EnableUserResponseDtoResponseTrafficLimitStrategy.NO_RESET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.last_connected_node, EnableUserResponseDtoResponseLastConnectedNodeType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_internal_squads_item_data in _active_internal_squads:
            active_internal_squads_item = EnableUserResponseDtoResponseActiveInternalSquadsItem.from_dict(
        ...
        def _parse_last_connected_node(
            data: object,
        ) -> Union["EnableUserResponseDtoResponseLastConnectedNodeType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_connected_node_type_0 = EnableUserResponseDtoResponseLastConnectedNodeType0.from_dict(data)

                return last_connected_node_type_0
            except:  # noqa: E722
                pass
            return cast(Union["EnableUserResponseDtoResponseLastConnectedNodeType0", None], data)

        last_connected_node = _parse_last_connected_node(d.pop("lastConnectedNode"))

        happ = EnableUserResponseDtoResponseHapp.from_dict(d.pop("happ"))

        _status = d.pop("status", UNSET)
        status: Union[Unset, EnableUserResponseDtoResponseStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = EnableUserResponseDtoResponseStatus(_status)
        ...
        if isinstance(_traffic_limit_strategy, Unset):
            ...
            traffic_limit_strategy = EnableUserResponseDtoResponseTrafficLimitStrategy(_traffic_limit_strategy)

        last_triggered_threshold = d.pop("lastTriggeredThreshold", UNSET)

        enable_user_response_dto_response = cls(
            uuid=uuid,
        ...
        enable_user_response_dto_response.additional_properties = d
        return enable_user_response_dto_response
