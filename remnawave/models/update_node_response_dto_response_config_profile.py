...
if TYPE_CHECKING:
    from ..models.update_node_response_dto_response_config_profile_active_inbounds_item import (
        UpdateNodeResponseDtoResponseConfigProfileActiveInboundsItem,
    )


T = TypeVar("T", bound="UpdateNodeResponseDtoResponseConfigProfile")


@_attrs_define
class UpdateNodeResponseDtoResponseConfigProfile:
    """
    Attributes:
        active_config_profile_uuid (Union[None, UUID]):
        active_inbounds (list['UpdateNodeResponseDtoResponseConfigProfileActiveInboundsItem']):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_inbounds_item_data in _active_inbounds:
            active_inbounds_item = UpdateNodeResponseDtoResponseConfigProfileActiveInboundsItem.from_dict(
                active_inbounds_item_data
            )

            active_inbounds.append(active_inbounds_item)

        update_node_response_dto_response_config_profile = cls(
            active_config_profile_uuid=active_config_profile_uuid,
            active_inbounds=active_inbounds,
        )

        update_node_response_dto_response_config_profile.additional_properties = d
        return update_node_response_dto_response_config_profile
