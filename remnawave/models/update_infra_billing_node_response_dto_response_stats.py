...
T = TypeVar("T", bound="UpdateInfraBillingNodeResponseDtoResponseStats")


@_attrs_define
class UpdateInfraBillingNodeResponseDtoResponseStats:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_infra_billing_node_response_dto_response_stats = cls(
            upcoming_nodes_count=upcoming_nodes_count,
            current_month_payments=current_month_payments,
            total_spent=total_spent,
        )

        update_infra_billing_node_response_dto_response_stats.additional_properties = d
        return update_infra_billing_node_response_dto_response_stats
