...
from ..models.create_host_response_dto_response_security_layer import CreateHostResponseDtoResponseSecurityLayer
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.create_host_response_dto_response_inbound import CreateHostResponseDtoResponseInbound


T = TypeVar("T", bound="CreateHostResponseDtoResponse")


@_attrs_define
class CreateHostResponseDtoResponse:
    """
    Attributes:
        uuid (UUID):
        view_position (int):
        ...
        security_layer (Union[Unset, CreateHostResponseDtoResponseSecurityLayer]):  Default:
            CreateHostResponseDtoResponseSecurityLayer.DEFAULT.
    ...
    security_layer: Union[Unset, CreateHostResponseDtoResponseSecurityLayer] = (
        CreateHostResponseDtoResponseSecurityLayer.DEFAULT
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inbound = CreateHostResponseDtoResponseInbound.from_dict(d.pop("inbound"))
        ...
        if isinstance(_security_layer, Unset):
            ...
            security_layer = CreateHostResponseDtoResponseSecurityLayer(_security_layer)

        is_hidden = d.pop("isHidden", UNSET)

        override_sni_from_address = d.pop("overrideSniFromAddress", UNSET)

        create_host_response_dto_response = cls(
            uuid=uuid,
        ...
        create_host_response_dto_response.additional_properties = d
        return create_host_response_dto_response
