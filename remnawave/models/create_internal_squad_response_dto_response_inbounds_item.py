...
T = TypeVar("T", bound="CreateInternalSquadResponseDtoResponseInboundsItem")


@_attrs_define
class CreateInternalSquadResponseDtoResponseInboundsItem:
    """
    Attributes:
        uuid (UUID):
        profile_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_internal_squad_response_dto_response_inbounds_item = cls(
            uuid=uuid,
        ...
        create_internal_squad_response_dto_response_inbounds_item.additional_properties = d
        return create_internal_squad_response_dto_response_inbounds_item
