...
if TYPE_CHECKING:
    from ..models.update_infra_billing_node_response_dto_response_available_billing_nodes_item import (
        UpdateInfraBillingNodeResponseDtoResponseAvailableBillingNodesItem,
    )
    from ..models.update_infra_billing_node_response_dto_response_billing_nodes_item import (
        UpdateInfraBillingNodeResponseDtoResponseBillingNodesItem,
    )
    from ..models.update_infra_billing_node_response_dto_response_stats import (
        UpdateInfraBillingNodeResponseDtoResponseStats,
    )


T = TypeVar("T", bound="UpdateInfraBillingNodeResponseDtoResponse")


@_attrs_define
class UpdateInfraBillingNodeResponseDtoResponse:
    """
    Attributes:
        total_billing_nodes (float):
        billing_nodes (list['UpdateInfraBillingNodeResponseDtoResponseBillingNodesItem']):
        available_billing_nodes (list['UpdateInfraBillingNodeResponseDtoResponseAvailableBillingNodesItem']):
        total_available_billing_nodes (float):
        stats (UpdateInfraBillingNodeResponseDtoResponseStats):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for billing_nodes_item_data in _billing_nodes:
            billing_nodes_item = UpdateInfraBillingNodeResponseDtoResponseBillingNodesItem.from_dict(
        ...
        for available_billing_nodes_item_data in _available_billing_nodes:
            available_billing_nodes_item = UpdateInfraBillingNodeResponseDtoResponseAvailableBillingNodesItem.from_dict(
        ...
        stats = UpdateInfraBillingNodeResponseDtoResponseStats.from_dict(d.pop("stats"))

        update_infra_billing_node_response_dto_response = cls(
        ...
        update_infra_billing_node_response_dto_response.additional_properties = d
        return update_infra_billing_node_response_dto_response
