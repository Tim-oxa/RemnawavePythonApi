...
from ..models.get_all_users_response_dto_response_users_item_status import GetAllUsersResponseDtoResponseUsersItemStatus
from ..models.get_all_users_response_dto_response_users_item_traffic_limit_strategy import (
    GetAllUsersResponseDtoResponseUsersItemTrafficLimitStrategy,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_all_users_response_dto_response_users_item_active_internal_squads_item import (
        GetAllUsersResponseDtoResponseUsersItemActiveInternalSquadsItem,
    )
    from ..models.get_all_users_response_dto_response_users_item_happ import GetAllUsersResponseDtoResponseUsersItemHapp
    from ..models.get_all_users_response_dto_response_users_item_last_connected_node_type_0 import (
        GetAllUsersResponseDtoResponseUsersItemLastConnectedNodeType0,
    )


T = TypeVar("T", bound="GetAllUsersResponseDtoResponseUsersItem")


@_attrs_define
class GetAllUsersResponseDtoResponseUsersItem:
    """
    Attributes:
        uuid (UUID):
        short_uuid (str):
        ...
        active_internal_squads (list['GetAllUsersResponseDtoResponseUsersItemActiveInternalSquadsItem']):
        subscription_url (str):
        last_connected_node (Union['GetAllUsersResponseDtoResponseUsersItemLastConnectedNodeType0', None]):
        happ (GetAllUsersResponseDtoResponseUsersItemHapp):
        status (Union[Unset, GetAllUsersResponseDtoResponseUsersItemStatus]):  Default:
            GetAllUsersResponseDtoResponseUsersItemStatus.ACTIVE.
        traffic_limit_bytes (Union[Unset, int]):  Default: 0.
        traffic_limit_strategy (Union[Unset, GetAllUsersResponseDtoResponseUsersItemTrafficLimitStrategy]): Available
            reset periods Default: GetAllUsersResponseDtoResponseUsersItemTrafficLimitStrategy.NO_RESET.
    ...
    last_connected_node: Union["GetAllUsersResponseDtoResponseUsersItemLastConnectedNodeType0", None]
    happ: "GetAllUsersResponseDtoResponseUsersItemHapp"
    status: Union[Unset, GetAllUsersResponseDtoResponseUsersItemStatus] = (
        GetAllUsersResponseDtoResponseUsersItemStatus.ACTIVE
    )
    traffic_limit_bytes: Union[Unset, int] = 0
    traffic_limit_strategy: Union[Unset, GetAllUsersResponseDtoResponseUsersItemTrafficLimitStrategy] = (
        GetAllUsersResponseDtoResponseUsersItemTrafficLimitStrategy.NO_RESET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.last_connected_node, GetAllUsersResponseDtoResponseUsersItemLastConnectedNodeType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.get_all_users_response_dto_response_users_item_happ import (
        ...
        for active_internal_squads_item_data in _active_internal_squads:
            active_internal_squads_item = GetAllUsersResponseDtoResponseUsersItemActiveInternalSquadsItem.from_dict(
        ...
        def _parse_last_connected_node(
            data: object,
        ) -> Union["GetAllUsersResponseDtoResponseUsersItemLastConnectedNodeType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_connected_node_type_0 = GetAllUsersResponseDtoResponseUsersItemLastConnectedNodeType0.from_dict(
                    data
                )
                ...
                pass
            return cast(Union["GetAllUsersResponseDtoResponseUsersItemLastConnectedNodeType0", None], data)

        last_connected_node = _parse_last_connected_node(d.pop("lastConnectedNode"))

        happ = GetAllUsersResponseDtoResponseUsersItemHapp.from_dict(d.pop("happ"))
        ...
        if isinstance(_status, Unset):
            ...
            status = GetAllUsersResponseDtoResponseUsersItemStatus(_status)
        ...
        if isinstance(_traffic_limit_strategy, Unset):
            ...
            traffic_limit_strategy = GetAllUsersResponseDtoResponseUsersItemTrafficLimitStrategy(
                _traffic_limit_strategy
            )

        last_triggered_threshold = d.pop("lastTriggeredThreshold", UNSET)

        get_all_users_response_dto_response_users_item = cls(
            uuid=uuid,
        ...
        get_all_users_response_dto_response_users_item.additional_properties = d
        return get_all_users_response_dto_response_users_item
