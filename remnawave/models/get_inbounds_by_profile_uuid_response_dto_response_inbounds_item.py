...
T = TypeVar("T", bound="GetInboundsByProfileUuidResponseDtoResponseInboundsItem")


@_attrs_define
class GetInboundsByProfileUuidResponseDtoResponseInboundsItem:
    """
    Attributes:
        uuid (UUID):
        profile_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_inbounds_by_profile_uuid_response_dto_response_inbounds_item = cls(
            uuid=uuid,
        ...
        get_inbounds_by_profile_uuid_response_dto_response_inbounds_item.additional_properties = d
        return get_inbounds_by_profile_uuid_response_dto_response_inbounds_item
