...
if TYPE_CHECKING:
    from ..models.get_all_nodes_response_dto_response_item_config_profile_active_inbounds_item import (
        GetAllNodesResponseDtoResponseItemConfigProfileActiveInboundsItem,
    )


T = TypeVar("T", bound="GetAllNodesResponseDtoResponseItemConfigProfile")


@_attrs_define
class GetAllNodesResponseDtoResponseItemConfigProfile:
    """
    Attributes:
        active_config_profile_uuid (Union[None, UUID]):
        active_inbounds (list['GetAllNodesResponseDtoResponseItemConfigProfileActiveInboundsItem']):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_inbounds_item_data in _active_inbounds:
            active_inbounds_item = GetAllNodesResponseDtoResponseItemConfigProfileActiveInboundsItem.from_dict(
                active_inbounds_item_data
            )

            active_inbounds.append(active_inbounds_item)

        get_all_nodes_response_dto_response_item_config_profile = cls(
            active_config_profile_uuid=active_config_profile_uuid,
            active_inbounds=active_inbounds,
        )

        get_all_nodes_response_dto_response_item_config_profile.additional_properties = d
        return get_all_nodes_response_dto_response_item_config_profile
