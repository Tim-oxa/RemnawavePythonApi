...
T = TypeVar("T", bound="GetInternalSquadByUuidResponseDtoResponseInboundsItem")


@_attrs_define
class GetInternalSquadByUuidResponseDtoResponseInboundsItem:
    """
    Attributes:
        uuid (UUID):
        profile_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_internal_squad_by_uuid_response_dto_response_inbounds_item = cls(
            uuid=uuid,
        ...
        get_internal_squad_by_uuid_response_dto_response_inbounds_item.additional_properties = d
        return get_internal_squad_by_uuid_response_dto_response_inbounds_item
