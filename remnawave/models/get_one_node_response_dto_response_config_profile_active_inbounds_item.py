...
T = TypeVar("T", bound="GetOneNodeResponseDtoResponseConfigProfileActiveInboundsItem")


@_attrs_define
class GetOneNodeResponseDtoResponseConfigProfileActiveInboundsItem:
    """
    Attributes:
        uuid (UUID):
        profile_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_one_node_response_dto_response_config_profile_active_inbounds_item = cls(
            uuid=uuid,
        ...
        get_one_node_response_dto_response_config_profile_active_inbounds_item.additional_properties = d
        return get_one_node_response_dto_response_config_profile_active_inbounds_item
