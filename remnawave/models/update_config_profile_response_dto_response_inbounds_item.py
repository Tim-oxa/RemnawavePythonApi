...
T = TypeVar("T", bound="UpdateConfigProfileResponseDtoResponseInboundsItem")


@_attrs_define
class UpdateConfigProfileResponseDtoResponseInboundsItem:
    """
    Attributes:
        uuid (UUID):
        profile_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_config_profile_response_dto_response_inbounds_item = cls(
            uuid=uuid,
        ...
        update_config_profile_response_dto_response_inbounds_item.additional_properties = d
        return update_config_profile_response_dto_response_inbounds_item
