...
from ..models.update_host_request_dto_alpn import UpdateHostRequestDtoAlpn
from ..models.update_host_request_dto_fingerprint import UpdateHostRequestDtoFingerprint
from ..models.update_host_request_dto_security_layer import UpdateHostRequestDtoSecurityLayer
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.update_host_request_dto_inbound import UpdateHostRequestDtoInbound


T = TypeVar("T", bound="UpdateHostRequestDto")
...
class UpdateHostRequestDto:
    ...
    Attributes:
        uuid (UUID):
        inbound (Union[Unset, UpdateHostRequestDtoInbound]):
        ...
        alpn (Union[Unset, UpdateHostRequestDtoAlpn]):
        fingerprint (Union[Unset, UpdateHostRequestDtoFingerprint]):
        is_disabled (Union[Unset, bool]):
        security_layer (Union[Unset, UpdateHostRequestDtoSecurityLayer]):
        ...
        override_sni_from_address (Union[Unset, bool]):
    """

    uuid: UUID
    inbound: Union[Unset, "UpdateHostRequestDtoInbound"] = UNSET
    ...
    alpn: Union[Unset, UpdateHostRequestDtoAlpn] = UNSET
    fingerprint: Union[Unset, UpdateHostRequestDtoFingerprint] = UNSET
    is_disabled: Union[Unset, bool] = UNSET
    security_layer: Union[Unset, UpdateHostRequestDtoSecurityLayer] = UNSET
    ...
    override_sni_from_address: Union[Unset, bool] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_inbound, Unset):
            ...
            inbound = UpdateHostRequestDtoInbound.from_dict(_inbound)
        ...
        if isinstance(_alpn, Unset):
            ...
            alpn = UpdateHostRequestDtoAlpn(_alpn)
        ...
        if isinstance(_fingerprint, Unset):
            ...
            fingerprint = UpdateHostRequestDtoFingerprint(_fingerprint)
        ...
        if isinstance(_security_layer, Unset):
            ...
            security_layer = UpdateHostRequestDtoSecurityLayer(_security_layer)
        ...
        update_host_request_dto.additional_properties = d
        return update_host_request_dto
