...
T = TypeVar("T", bound="GetConfigProfilesResponseDtoResponseConfigProfilesItemInboundsItem")


@_attrs_define
class GetConfigProfilesResponseDtoResponseConfigProfilesItemInboundsItem:
    """
    Attributes:
        uuid (UUID):
        profile_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_config_profiles_response_dto_response_config_profiles_item_inbounds_item = cls(
            uuid=uuid,
        ...
        get_config_profiles_response_dto_response_config_profiles_item_inbounds_item.additional_properties = d
        return get_config_profiles_response_dto_response_config_profiles_item_inbounds_item
