...
from ..models.get_user_by_short_uuid_response_dto_response_status import GetUserByShortUuidResponseDtoResponseStatus
from ..models.get_user_by_short_uuid_response_dto_response_traffic_limit_strategy import (
    GetUserByShortUuidResponseDtoResponseTrafficLimitStrategy,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_user_by_short_uuid_response_dto_response_active_internal_squads_item import (
        GetUserByShortUuidResponseDtoResponseActiveInternalSquadsItem,
    )
    from ..models.get_user_by_short_uuid_response_dto_response_happ import GetUserByShortUuidResponseDtoResponseHapp
    from ..models.get_user_by_short_uuid_response_dto_response_last_connected_node_type_0 import (
        GetUserByShortUuidResponseDtoResponseLastConnectedNodeType0,
    )


T = TypeVar("T", bound="GetUserByShortUuidResponseDtoResponse")


@_attrs_define
class GetUserByShortUuidResponseDtoResponse:
    """
    Attributes:
        uuid (UUID):
        short_uuid (str):
        ...
        active_internal_squads (list['GetUserByShortUuidResponseDtoResponseActiveInternalSquadsItem']):
        subscription_url (str):
        last_connected_node (Union['GetUserByShortUuidResponseDtoResponseLastConnectedNodeType0', None]):
        happ (GetUserByShortUuidResponseDtoResponseHapp):
        status (Union[Unset, GetUserByShortUuidResponseDtoResponseStatus]):  Default:
            GetUserByShortUuidResponseDtoResponseStatus.ACTIVE.
        traffic_limit_bytes (Union[Unset, int]):  Default: 0.
        traffic_limit_strategy (Union[Unset, GetUserByShortUuidResponseDtoResponseTrafficLimitStrategy]): Available
            reset periods Default: GetUserByShortUuidResponseDtoResponseTrafficLimitStrategy.NO_RESET.
    ...
    last_connected_node: Union["GetUserByShortUuidResponseDtoResponseLastConnectedNodeType0", None]
    happ: "GetUserByShortUuidResponseDtoResponseHapp"
    status: Union[Unset, GetUserByShortUuidResponseDtoResponseStatus] = (
        GetUserByShortUuidResponseDtoResponseStatus.ACTIVE
    )
    traffic_limit_bytes: Union[Unset, int] = 0
    traffic_limit_strategy: Union[Unset, GetUserByShortUuidResponseDtoResponseTrafficLimitStrategy] = (
        GetUserByShortUuidResponseDtoResponseTrafficLimitStrategy.NO_RESET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.last_connected_node, GetUserByShortUuidResponseDtoResponseLastConnectedNodeType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_internal_squads_item_data in _active_internal_squads:
            active_internal_squads_item = GetUserByShortUuidResponseDtoResponseActiveInternalSquadsItem.from_dict(
        ...
        def _parse_last_connected_node(
            data: object,
        ) -> Union["GetUserByShortUuidResponseDtoResponseLastConnectedNodeType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_connected_node_type_0 = GetUserByShortUuidResponseDtoResponseLastConnectedNodeType0.from_dict(data)

                return last_connected_node_type_0
            except:  # noqa: E722
                pass
            return cast(Union["GetUserByShortUuidResponseDtoResponseLastConnectedNodeType0", None], data)

        last_connected_node = _parse_last_connected_node(d.pop("lastConnectedNode"))

        happ = GetUserByShortUuidResponseDtoResponseHapp.from_dict(d.pop("happ"))
        ...
        if isinstance(_status, Unset):
            ...
            status = GetUserByShortUuidResponseDtoResponseStatus(_status)
        ...
        if isinstance(_traffic_limit_strategy, Unset):
            ...
            traffic_limit_strategy = GetUserByShortUuidResponseDtoResponseTrafficLimitStrategy(_traffic_limit_strategy)

        last_triggered_threshold = d.pop("lastTriggeredThreshold", UNSET)

        get_user_by_short_uuid_response_dto_response = cls(
            uuid=uuid,
        ...
        get_user_by_short_uuid_response_dto_response.additional_properties = d
        return get_user_by_short_uuid_response_dto_response
