...
T = TypeVar("T", bound="EnableNodeResponseDtoResponseConfigProfileActiveInboundsItem")


@_attrs_define
class EnableNodeResponseDtoResponseConfigProfileActiveInboundsItem:
    """
    Attributes:
        uuid (UUID):
        profile_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        enable_node_response_dto_response_config_profile_active_inbounds_item = cls(
            uuid=uuid,
        ...
        enable_node_response_dto_response_config_profile_active_inbounds_item.additional_properties = d
        return enable_node_response_dto_response_config_profile_active_inbounds_item
