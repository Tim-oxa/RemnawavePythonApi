...
T = TypeVar("T", bound="GetOneHostResponseDtoResponseInbound")


@_attrs_define
class GetOneHostResponseDtoResponseInbound:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_one_host_response_dto_response_inbound = cls(
            config_profile_uuid=config_profile_uuid,
            config_profile_inbound_uuid=config_profile_inbound_uuid,
        )

        get_one_host_response_dto_response_inbound.additional_properties = d
        return get_one_host_response_dto_response_inbound
