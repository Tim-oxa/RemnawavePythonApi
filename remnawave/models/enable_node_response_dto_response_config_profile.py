...
if TYPE_CHECKING:
    from ..models.enable_node_response_dto_response_config_profile_active_inbounds_item import (
        EnableNodeResponseDtoResponseConfigProfileActiveInboundsItem,
    )


T = TypeVar("T", bound="EnableNodeResponseDtoResponseConfigProfile")


@_attrs_define
class EnableNodeResponseDtoResponseConfigProfile:
    """
    Attributes:
        active_config_profile_uuid (Union[None, UUID]):
        active_inbounds (list['EnableNodeResponseDtoResponseConfigProfileActiveInboundsItem']):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_inbounds_item_data in _active_inbounds:
            active_inbounds_item = EnableNodeResponseDtoResponseConfigProfileActiveInboundsItem.from_dict(
                active_inbounds_item_data
            )

            active_inbounds.append(active_inbounds_item)

        enable_node_response_dto_response_config_profile = cls(
            active_config_profile_uuid=active_config_profile_uuid,
            active_inbounds=active_inbounds,
        )

        enable_node_response_dto_response_config_profile.additional_properties = d
        return enable_node_response_dto_response_config_profile
