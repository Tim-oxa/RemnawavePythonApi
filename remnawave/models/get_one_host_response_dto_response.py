...
from ..models.get_one_host_response_dto_response_security_layer import GetOneHostResponseDtoResponseSecurityLayer
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_one_host_response_dto_response_inbound import GetOneHostResponseDtoResponseInbound


T = TypeVar("T", bound="GetOneHostResponseDtoResponse")


@_attrs_define
class GetOneHostResponseDtoResponse:
    """
    Attributes:
        uuid (UUID):
        view_position (int):
        ...
        mux_params (Any):
        sockopt_params (Any):
        inbound (GetOneHostResponseDtoResponseInbound):
        server_description (Union[None, str]):
        tag (Union[None, str]):
        is_disabled (Union[Unset, bool]):  Default: False.
        security_layer (Union[Unset, GetOneHostResponseDtoResponseSecurityLayer]):  Default:
            GetOneHostResponseDtoResponseSecurityLayer.DEFAULT.
    ...
    security_layer: Union[Unset, GetOneHostResponseDtoResponseSecurityLayer] = (
        GetOneHostResponseDtoResponseSecurityLayer.DEFAULT
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inbound = GetOneHostResponseDtoResponseInbound.from_dict(d.pop("inbound"))
        ...
        if isinstance(_security_layer, Unset):
            ...
            security_layer = GetOneHostResponseDtoResponseSecurityLayer(_security_layer)

        is_hidden = d.pop("isHidden", UNSET)

        override_sni_from_address = d.pop("overrideSniFromAddress", UNSET)

        get_one_host_response_dto_response = cls(
            uuid=uuid,
        ...
        get_one_host_response_dto_response.additional_properties = d
        return get_one_host_response_dto_response
