...
T = TypeVar("T", bound="GetOneNodeResponseDtoResponseProviderType0")


@_attrs_define
class GetOneNodeResponseDtoResponseProviderType0:
    """
    Attributes:
        uuid (UUID):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_one_node_response_dto_response_provider_type_0 = cls(
            uuid=uuid,
            name=name,
        ...
        get_one_node_response_dto_response_provider_type_0.additional_properties = d
        return get_one_node_response_dto_response_provider_type_0
