...
if TYPE_CHECKING:
    from ..models.get_subscription_settings_response_dto_response_custom_response_headers_type_0 import (
        GetSubscriptionSettingsResponseDtoResponseCustomResponseHeadersType0,
    )


T = TypeVar("T", bound="GetSubscriptionSettingsResponseDtoResponse")


@_attrs_define
class GetSubscriptionSettingsResponseDtoResponse:
    """
    Attributes:
        uuid (UUID):
        profile_title (str):
        ...
        custom_response_headers (Union['GetSubscriptionSettingsResponseDtoResponseCustomResponseHeadersType0', None]):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(
            self.custom_response_headers, GetSubscriptionSettingsResponseDtoResponseCustomResponseHeadersType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_custom_response_headers(
            data: object,
        ) -> Union["GetSubscriptionSettingsResponseDtoResponseCustomResponseHeadersType0", None]:
            if data is None:
                return data
            try:
                ...
                custom_response_headers_type_0 = (
                    GetSubscriptionSettingsResponseDtoResponseCustomResponseHeadersType0.from_dict(data)
                )

                return custom_response_headers_type_0
            except:  # noqa: E722
                pass
            return cast(Union["GetSubscriptionSettingsResponseDtoResponseCustomResponseHeadersType0", None], data)
        ...
        get_subscription_settings_response_dto_response = cls(
            uuid=uuid,
        ...
        get_subscription_settings_response_dto_response.additional_properties = d
        return get_subscription_settings_response_dto_response
