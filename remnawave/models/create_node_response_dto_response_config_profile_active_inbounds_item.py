...
T = TypeVar("T", bound="CreateNodeResponseDtoResponseConfigProfileActiveInboundsItem")


@_attrs_define
class CreateNodeResponseDtoResponseConfigProfileActiveInboundsItem:
    """
    Attributes:
        uuid (UUID):
        profile_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_node_response_dto_response_config_profile_active_inbounds_item = cls(
            uuid=uuid,
        ...
        create_node_response_dto_response_config_profile_active_inbounds_item.additional_properties = d
        return create_node_response_dto_response_config_profile_active_inbounds_item
